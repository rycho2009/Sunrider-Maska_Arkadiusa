...
#####################################VARIABLE SET UP
    ...
    if store.Difficulty == 3:
        $ show_message('Wybierz poziom trudności.',0.5,0.8,2)
    ...
    kay "Ile jeszcze zejdzie, zanim się tam dostaniemy?"
    pi "Już tylko moment. Nie możesz się już doczekać, aż spotkasz się ze swoją ślicznotką?"
    kay "Nie widziałem Avy odkąd byliśmy w liceum. Wątpię, czy wogóle mnie pamięta.."
    pi "Dowódco? Psh, nie ją! Miałem na myśli Sunrider. Najnowszy okręt w naszej flocie!"
    pi "Proszę o zezwolenie na obrócenie statku by Ci go pokazać."
    ...
    pi "Tak, spójrz na nią. Tak zaawansowany, że kadry były zmuszone wyszkolić nową linię oficerów, aby ją latali."
    kay "Sounds like a fine vessel..."
    pi "Trzymaj się, kapitanie. To już nie potrwa długo."
    ...
    ava "Kapitan na pokładzie!"

    show ava uniform neutral neutral with dissolve

    ava "Witam na pokładzie, Kaptanie. Pierwsza Oficer Ava Crescentia melduje się do służby."

    menu:
        "At ease, commander.":
            jump at_ease

        "Minęło trochę czasu, Ava.":
...
label its_been_awhile:
    ...
    kay "Ostatni raz widzieliśmy się, jak skończyłaś szkołę średnią. Nigdy nawet nie śniłem, że kiedykolwiek zostanę twoim oficerem dowodzącym."
    ...
    menu:
        "Myślę, że trochę się zmieniło od wtedy.":
            jump things_have_changed

        "Będzie znów jak za starych czasów.":
            jump old_times
...
label old_times:
    ...
    kay "Anyways, don't be too awkward around me, alright? Od teraz będę na ciebie liczyć."

    show ava uniform salute neutral with dissolve

    ava "Zrozumiano kapitanie."
    kay "Nie jestem pewien czy rozumiesz..."
...
label give_report:
    kay "Zdaj raport ze statusu Sunridera."

    show ava uniform alt neutral neutral with dissolve

    ava "Pracowaliśmy przez ubiegłe dwa tygodnie testując jego systemy. She's prepped to go on your word, sir."
    kay "Dobrze. It sounds like High Command wants us out of here asap."

label give_report_menu:
    menu:
        "Powiedz mi coś więcej o Sunriderze":
            jump tell_more_Sunrider

        "Powiedz mi coś więcej o tym pomarańczowym alarmie.":
...
label tell_more_Sunrider:
    ...
    show ava uniform alt neutral neutral with dissolve
    ava "Jest najnowszym statkiem w naszej flocie. Jest uzbrojona jak okręt wojenny, ale zbudowana jak lotniskowiec. We can field up to twelve ryders and also provide capital ship support for them."
...
label tell_more_orange_alert:
    ...
    ava "Nie mów mi, że nie wiesz. Rynar's surrendered to PACT just this morning."
    kay "Już? That's another neutral world that's been taken by PACT."
    ava "Not only that, but PACT's taken Minerva, Barona, and Gerald in the past three months. Jedna neutralna planeta za drugą. Jak myślisz - co to znaczy?"
    kay "Osaczenie. Jesteśmy następni."
    ava "Dokładnie. Dlatego właśnie Dowództwo nie podejmuje żadnego ryzyka. If any hostiles enter our gravity well, we're to open fire first and ask questions later."
    jump give_report_menu

label give_report_move_on:

    show ava uniform alt neutral neutral with dissolve
    ava "Pierwsze, oprowadzenie po statku."
    kay "Oh good."
    ava "Jak już pewnie zauważyłeś, to jest hangar Sunridera. We can store up to twelve ryders here."
    kay "I don't see any ryders here. Gdzie teraz są?"
    ava "Nie dostaniemy ich przed Środą. Gdy już tu będą, będziesz mógł uzyskać do nich dostęp i zarządzać zmianami wyposażenia."
    ava "To jest interaktywna mapa Sunridera. Możesz używać jej do poruszania się po statku."
    ava "Udamy się do mostu znajdującego się nad nami, na pokładzie 1."
    ava "Spróbuj użyć mapy statku. Upewnij się, że naciśniesz zakładkę Pokład 1 pierwszą."
...
label bridge_tour:
    ...
    ava "To jest główny mostek Sunridera. To jest miejsce, w którym bedziesz dowodzić statkiem."
    kay "Widzę na środku całkiem gustowną mapę gwiezdną."
    ava "You can use that star map to plot our course and to warp to other systems."
    ava "Będę tutaj również dość często jeśli czegokolwiek byś ode mnie potrzebował."
...
label engineering_tour:
    ...
    ava "To są pomieszczenia inżynieryjne. Główny reaktor statku znajduje się tutaj, jak również laboratorium,\
    którego możemy używać do odkrywania i konstruowania nowego ekwipunku. Niefortunnie, laboratorium jest jeszcze nie otwarte."
    kay "Będzie ono również dostępne w Środę?"
    ava "Zgadza się."
...
label messhall_tour:
    ...
    ava "To jest okrętowa kantyna. Możemy tutaj zejść coś zjeść i zrelaksować się po pracy."
    kay "Dla mnie brzmi dobrze."
...
label captainsloft_tour:
    ...
    ava "Wreszcie, to są twoje osobiste kwatery."
    ...
    ava "Proszę nie zaśmieć za bardzo swojego pokoju, kapitanie."
    kay "Już mam kilka pomysłów jak go poprawić."
    ...
    ava "Możesz używać mapy do poruszania się po statku. Zachęcam do interakcji z członkami załogi kiedy tylko jest to możliwe."
    kay "W porządku. Szczęśliwy statek tworzy silny statek."
    ava "I to kończy naszą wycieczkę. Tak jak mówiłam, będę na mostku większość czasu, więc możesz podejść do mnie jeśli będziesz potrzebować pomocy."
    kay "Co dalej?"
    ava "Obawiam się, że będziemy musieli skrócić formalności, kapitanie. Tak jak mówiłam, Dowództwo chce byśmy opuścili doki tak szybko jak tylko to możliwe."
    ava "Mamy zaplanowane pierwsze testowe uruchomienie silników. We'll be sailing port shortly and making one loop around the moon."
    kay "Fine with me. Wróćmy na mostek i zobaczmy na co stać Sunridera."
    ...
    kay "Man your stations. Aktywujcie główny reaktor i uruchomcie silniki. Momentarily, we'll begin a live test of our engines by sailing port and making one round to the moon."
    ...
    ava "Główny reaktor budzi się, kapitanie. Moc się zwiększa."
    kay "Obudź naszą damę, Ava. Wynosimy się stąd."

    show ava uniform order talk with dissolve

    ava "Aye sir. Sterniku, odpalaj silniki."

    show ava uniform handonhip neutral with dissolve

    ava "Inżynierowie meldują, że reaktor funkcjonuje już z odpowiednimi parametrami."
    ava "Moc zwiększa się w silnikach."
    ...
    ava "Ugh..."
    kay "Co to do diabła było!?"

    show ava uniform alt neutral angry with dissolve

    ava "Sprawdzanie statusu."
    ava "Inżynierowie meldują, że rdzeń reaktora jest stabilny. Nie wykryto eksplozji zarówno na pokładzie 0 jak i 2."
    ava "Kapitanie, jedynem miejscem, z którego mogł dochodzić odgłos wybuchów musi być na zewnątrz."
    kay "Na zewnątrz!? As in-"
    ava "Kontakt! PACT warp signatures detected!"
    kay "Co?"
    ava "Missile boats! Wskoczyli akurat pod nasze nosy!"
    kay "Czerwony alarm! Odwołać sprawdzanie silników!"
    ...
    kay "To zmieniło się w jedno piekło z dziewiczego lotu. Ava, jaki mamy status broni?"

    show ava uniform alt neutral mad with dissolve

    ava "Ograniczona. The vanguard cannon is still off line. We have flak turrets, saviors, and a few shots of hell darts."
    kay "... ... ..."
    ava "Kapitanie... Nie myślisz serio o wzięciu Sunridera do bitwy, czyż nie? Nawet nie ukończyliśmy żadnego z naszych testów silnika, nie wspominając o kontroli amunicji."
    ...
    ava "Aye sir. Sternik, cała moc do silników!"
    ava "Ostrzeżenie, mamy jednego wroga!"
    ...
    ava "Nie mamy wątpliwości. Sunrider dołącza do walki."
    kay "Odpalić działa! Take these bastards out!"
...
label mission1:
    ...
    if not battle1_check1:  #if you don't check for a flag like this you'll see this dialogue every loop.
        ...
        ava "Witam na ekranie taktycznym, kapitanie. Stąd możesz wydawać rozkazy do załogi w trakcie bitwy."
        ava "Z przodu, widzisz siatkę bitewną. Siatka ta pokazuje, gdzie są umiejscowieni sojusznicy i przeciwnicy na polu bitwy."
        ava "Możesz nacisnąć lewy klawisz myszy i przesuwać myszką by poruszać kamerę po polu bitwy. Możesz również użyć rolki by przybliżyć lub oddalić kamerę."
        ...
        ava "Zarówno ruch jak i atak zużywa energię. Każda jednostka ma określoną liczbę punktów energii. Gdy wszystkie jednostki pod twoim dowodzeniem nie będą miały już wystarczająco energii do działania, musisz zakończyć twoją."
        ava "PACT units are indicated by the red ring. Your current objective is to eliminate all PACT units from the map."
        ava "Sunrider jest uzbrojony w wszechstronny zestaw broni, aby wykonać to zadanie."
        ava "Broń laserowa ma najdłuższy zasięg, ale zadaje niskie obrażenia. Kinetic based weapons have short range, but pack a punch. Missile based weapons have both long range and firepower, but are limited in supply, and so must be used wisely."
        ava "Use the Sunrider's weapons to eliminate the PACT missile frigates. Powodzenia, kapitanie."
...
label after_mission1:
    ...
    ava "Alarm! Nowe sygnatury na skanerze!"
    kay "More missile frigates?"
    ava "Nie... To nie wygląda jak nic, co kiedykolwiek widziałam."
    ...
    ava "Słodka matko Boga..."
    kay "Co to jest, Ava!? I don't remember PACT having anything that colossal!"

    show ava uniform alt neutral mad with dissolve

    ava "Właśnie otrzymuję dane od kwatery głównej... It's the PACT Super-Dreadnought class warship Legion."

    show ava uniform alt neutral angry with dissolve

    ava "Ponad trzy kilometry długości... Uzbrojony wystarczająco by zdezintegrować trzykrotnie większą flotę niż naszą! That thing's Veniczar S. Arcadius' personal flagship!"
    ava "Dowództwo wydało rozkaz ogólnego odwrotu! Wszystkie jednostki mają się wycofać! Biuro Głównego Premiera niezwłoczne bezwarunkowe poddanie się!"
    kay "Poddanie się? To już koniec?"

    show ava uniform alt order angry with dissolve

    ava "Uwaga! Wykryłam olbrzymi wzrost mocy z tego okrętu... Czekaj! Przygotuj się na uderzenie!"
    ...
    kay "Wyłamać się! Nasz statek nie ma szans przeciwko temu!"
    ava "Okręt wojenny wroga ponownie szykuje się do ataku!"
    ...
    kay "R-raportuj!"
    ava "Ten okręt wojenny ostatnim strzałem uderzył w Cerę. Wciąż próbuję oszacować zakres szkód, ale..."
    kay "N-niewiarygodne... Aby użyć broni tej wielkości na cywilnym celu..."
    ava "Straty w cywilach wynoszą ponad milion! Cały kontakt z dowództwem cywilnym oraz wojskowym został utracony!"
    ava "Reszta Kosmicznych Sił Cery rozprasza się! We're going to get overwhelmed if we don't get out of here!"
    ava "Jakie są twoje rozkazy, kapitanie!?"
    kay "... ... ..."
    ava "KAPITANIE!!"
    ...
    "The pounding wasn't coming from the enemy. To było jego własne serce."
    kay "Wycofać się..."
    kay "... ... ..."
    kay "Wycofać się! Warp to the nearest safe harbor!"
    ...
    ava "Nawigatorze, wprowadź współrzędne wycofania się do komputera! Spool up the warp drive and prepare to jump!"
    kay "... ... ..."
    "Shield po raz ostatni spojrzał na swój płonący rodzimy świat."
    "To nie był koniec."
    "Zamierzał wrócić. Bez względu na cenę."
...
label chap1_start:
    ...
    "Shield w swoim biurze, pisząc swój dziennik."
    kay "{i}Minął tydzień od upadku Cery. Despite our best efforts, we have been unable to regroup with the rest of the Cera Space Force. The crew is starting to fear that we may be the only ones who got out of that massacre in one piece. To tell the truth, I'm beginning to believe that too.{/i}"
    kay "{i}Nie wiem co powinniśmy zrobić ani jaki następny krok powinniśmy podjąć. Wiem tylko, że odtąd będziemy sami.{/i}"
    "Dzwonek u drzwi przerwał rozmyślania kapitana Shielda."
    kay "Wejść."

    show ava uniform armscrossed neutral with dissolve

    ava "Kapitanie."
    kay "Jakieś wiadomości z floty?"
    ava "Żadnych."
    kay "... ... ..."
    ava "Załoga zaczyna się martwić. Nie robiliśmy nic oprócz skanowania przez ostatni tydzień. If a PACT force finds us, we're sitting ducks here."

    menu:
        "Sugerujesz byśmy zrezygnowali z poszukiwań?":
            jump giveupsearch
        "Zgadza się. Myślę, że zmarnowaliśmy tutaj dość naszego czasu.":
...
label shipwithoutflag:
    kay "Ava, powiedz mi coś. Czym jest statek bez flagi?"
    ...
    menu:
        "Statek piracki Sunrider. Podoba mi się wydźwięk tego określenia.":
...
label pirateshipsunrider:
    ...
    ava "Sugerujesz byśmy się zbuntowali?"
    kay "Myślę, że nie mamy zbyt dużego wyboru. Już nie ma naszego rządu. Od teraz będziemy musieli działać sami."
...
label notapiratecaptain:
    ...
    ava "Nie sugerowałam, abyśmy szli ku piractwu."
    kay "Zapamiętaj, Ava. Sunrider zawsze będzie nosić flagę Cery."
    jump whatareyousuggesting

label whatareyousuggesting:

    ava "Więc co sugerujesz?"
    kay "PACT won't get away with what they did to our home. We're going to take the fight to them."

    show ava uniform armscrossed neutral with dissolve

    ava "Tylko z jednym statkiem?"
    kay "Znajdziemy sojuszników. Nie jesteśmy jedynym neutralnym światem zdobytym przez nich."
    kay "Znajdziemy innych takich jak my. Razem zbudujemy flotę. A następnie ponownie odbierzemy wszystkie planety, jedna po drugiej."
    ava "Hm. Przypuszczam, że masz już plan."

    menu:
        "Jak za starych czasów, Ava.":
            jump justlikeoldtimes

        "Are you questioning my orders, commander?":
            jump questioningorders

        "Nie jestem już dzieckiem jakim mnie pamiętasz, Ava.":
...
label justlikeoldtimes:
    ...
    ava "Dobrze, że ustawili mnie jako twoją Pierwszą Oficer. Nawet nie chcę sobie wyobrażać ile przysporzyłbyś kłopotów, gdyby mnie tu nie było, by po tobie posprzątać."
    kay "Hahaha. Daj spokój, to wszystko, co pamiętasz o mnie ze szkoły średniej?"
    ava "Cóż, pamiętam, że z pewnością byłeś jednym z najbardziej frustrujących młodych ludzi, z którymi miała do czynienia przewodnicząca rady studenckiej..."
    ava "Pamiętam, jak zainstalowałeś urządzenie antygrawitacyjne w pokoju rady studenckiej. Po wszystkim nie można było wszystkiego doczyścić."
    kay "Ah, ta drobnostka. Come on, you had a good laugh afterwards, didn't you?"
...
label notthekidyouremember:
    ...
    kay "Nie jestem już dzieckiem jakim mnie pamiętasz, Ava."
    kay "Nie możemy dać się tak łatwo pokonać. If PACT pushes us, I say we push back. The Sunrider's still got a lot of fight left in her yet."

    show ava uniform alt neutral neutral with dissolve

    ava "W porządku. Walczmy."
    ava "Muszę Ci powiedzieć, kapitanie..."
    kay "Co jest?"
    ava "Dalej ani trochę się nie zmieniłeś."
...
label newordersjumptotydaria:
    ...
    ava "Zrozumiano. The ship will be prepared to warp at your command."

    menu:
        "Jaki jest status Sunridera?":
            jump statusofthesunrideraftercera

        "Jak się trzymasz po tym co się wydarzyło?":
...
label statusofthesunrideraftercera:
    ...
    ava "Miał lepsze dni. Musieliśmy przepłynąć port, zanim mogliśmy zakończyć którykolwiek z naszych testów. Our missiles are empty and our Vanguard Cannons are still offline."
    ava "I to nie jest jeszcze najgorsze. We had to leave Cera before we could pick up any of our ryders. Not only that, but we're missing our chief engineer and our doctor. Zarówno Laboratoria jak i Izba Chorych są spowite mrokiem."
    ...
    ava "Prowadzenie statku wymaga pieniędzy. Szukałam sposobów na błyskawiczne zdobycie gotówki."
    ...
    ava "Correct. We'll be paid a sum of money for each PACT target we sink. Większy cel, większa nagroda."
...
label howareyouholdingup:
    ...
    ava "Jestem... w porządku, kapitanie. Nie ma powodu, by się o mnie martwić."
    kay "Jesteś pewna?"

    show ava uniform alt neutral neutral with dissolve

    ava "Tak. Mamy chwilowo większe problemy."
    kay "Przypuszczam, że masz rację."
    ava "W rzeczy samej."
...
label Tydaria_jump1:
    ...
    ava "Jaki rodzaj pomocy myślisz jesteśmy w stanie tutaj uzyskać?"
    ...
    kay "Flaga?"
    ava "Nie znajduję żadnej, jaką mamy zapisaną w rejestrze flag..."
    ...
    kay "Czerwony alarm! Wznieście tarcze i zasilcie broń!"
    ...
    kay "Stand down. To jest okręt wojenny Kosmicznych Sił Cery. We will not hesitate to open fire if you approach."
    ...
    ava "Na dodatek zbliżają się dwa pirackie niszczyciele. Oczekiwany czas do przybycia: Dziesięć minut."
    kay "Spróbujmy to zakończyć zanim przybędą niszczyciele. Concentrate all firepower on the lead pirate ryder!"
    kay "Besides, she just looks like a little girl. Może drobny pokaz siły pomoże pokazać jej właściwe miejsce"

    show ava uniform armscrossed frown with dissolve

    ava "Kapitanie... Proszę nie lekceważyć przeciwnika..."
...
label mission2:
    ...
    if not battle2_check1:
        ...
        ava "We're heavily outnumbered, captain. Jakie są rozkazy?"
    ...
    if battle2_check2 == False and sunrider.hp < sunrider.max_hp:
        ...
        cos "Teraz jest nasza szansa! Take their engines out, but leave the ship intact!"
        ...
        cos "Hurk..."
        cos "Czy... ty... właśnie... nazwałeś... mnie..."
        ...
        cos "T-TYYYYYYY!!!"
        cos "ZABIĆ ICH WSZYSTKICH! ALE KAPITANA ZOSTAWCIE DLA MNIE!"
        cos "ON JEST... MÓJ!"
        ...
        ava "Kapitanie... Proszę nie prowokować wrogów..."

        hide ava uniform armscrossed looklefttalk onlayer screens with dissolve

        kay "Szlag... Problem za problemem..."
        ...
        asa "Kawaleria przybyła!"
        kay "Co do... Kim jesteś?"

        show asaga plugsuit vpose onlayer screens with dissolve

        asa "BOHATEREM SPRAWIEDLIWOŚCI!"
        ...
        kay "Wygląda na to, że nie mamy zbytniego wyboru."
...
label after_mission2:
    ...
    asa "Whew, that sure was hairy! Nigdy bym nie pomyślała, że piraci wybiorą się na okręt wojskowy!"
...
label dontbesouptight:
    ...
    kay "I'm Captain Kayto Shields of the assault carrier Sunrider. Excuse my first officer, Commander Ava Crescentia. Nie jest taka zła jak wygląda na pierwszy rzut oka. Who are you?"
...
label sorryregularprotocol:
    ...
    ava "L-lady...?"
    kay "Hahaha. I'm Captain Kayto Shields of the assault carrier Sunrider. The mean lady beside me is Commander Ava Crescentia. A ty kim jesteś?"
...
label tellmorepirates:
    ...
    asa "Piraci w tym sektorze są dowodzeni przez paskudną dziewcznę - Cosette Cosmos. Już ją spotkałeś."
    kay "What's a little girl like that doing committing piracy?"
    asa "Cosette może wyglądać jak bachor, ale nie lekceważ jej. Przeraża cały sektor jako bezwzględny pirat. Słyszałam nawet pogłoski, że pewnego dnia poderżneła gardło własnemu ojcu za to, że nie kupił jej cukierków na jej 14te urodziny."
    ...
    kay "Dzięki, będę o tym pamiętać."
...
label moveonnextaction:
    ...
    kay "Zgadza się."
    asa "Dlaczego nie połączymy sił na jakiś czas? From the look of things here, you seem to be an assault carrier without any ryders. Help me take care of these pirates, and I'll join you guys as the Sunrider's first ryder."

    show ava uniform armscrossed frown with dissolve

    ava "Kapitanie, nie wiemy, czy możemy ufać tej dziewczynie. Dopiero ją poznaliśmy!"

    menu:
        "Właśnie uratowała nasze plecy. Na dodatek ma rację. A carrier without any ryders is useless. I say we work together for now.":
            jump savednecksworktogether
        "Przykro mi, Asaga. Nie sądzę, żebym mógł Ci pozwolić dołączyć do drużyny bez narażania Avy na tygodniową bezsenność.":
...
label sorryasagaavalosesleep:
    ...
    asa "Aww..."
    kay "Ale myślę, że możesz trochę pozostać na pokładzie. I don't want to be caught without a ryder if the pirates decide to come back with reinforcements."
...
label fornowsunriderrepairs:
    ...
    if ChigaraNamed:
        ...
        asa "Uh-huh! Ona jest geniuszem jeśli chodzi o technologie!"
    ...
    kay "P-piekarnia...? Didn't Asaga say this was a workshop?"
    ava "Wiedziałam, że nie powinniśmy jej ufać..."
    ...
    chi "Ah... I przyszłaś z przyjaciółmi..."

    show asaga plugsuit altneutral happy with dissolve

    asa "Uh huh, to jest kapitan Kayto Shields z statku kosmicznego Sunrider! And that lady's First Officer Ava Crescentia."
    ...
    hide ava with dissolve
    kay "Miło cię poznać. Musisz być Chigarą."

    chi "Umm... Chigara Lynn Ashada to moje pełne imię, ale tak mnie Asaga nazywa."
...
label beingabakery:
    ...
    chi "Uuuu... Nie. Everyone seems much more interested in getting their ship fixed..."
    kay "So why don't you just open a dry dock instead of a bakery?"

    show asaga plugsuit handsonhips mad with dissolve

    asa "Oy, oy! Zawsze marzeniem Chigary było otwarcie piekarni! You can't just shut a girl's dreams down like that!"
...
label girltohaveaworkship:
    ...
    chi "Nie zupełnie.  Tydaria is one of the Mining Union's primary worlds.  I've been renting this dock from the Union and patching up ships with Asaga for a while now."
...
label completeourtestsandresupply:
    ...
    chi "Mmm... Wygląda na to, że większość uszkodzeń została zadana zewnętrznemu kadłubowi. To nie powinno być zbyt ciężkie w naprawie."
    ...
    asa "Ufufufu... Nie martw się, kapitanie. Chigara jest szalonym geniuszem jeśli chodzi o technologie. Nigdy nie widziałam nawet jednej maszyny, której nie potrafiłaby naprawić."
    kay "Spójrz tutaj. Widzisz to? That's a busted power convertor that took a lab of twelve scientists a month to make. Nie ma mowy byś mogła to naprawić!"

    show chigara plugsuitlabcoat altneutral forcedsmile with dissolve

    chi "Ummm... W zasadzie zrobiłam wczoraj wieczorem we śnie to małe urządzenie... Byłam naprawdę zmieszana, gdy się obudziłam i ujrzałam konwerter mocy w moim łóżku, ale myślę, że powinien działać perfekcyjnie w twoim statku."
    kay "Co..."
    asa "C'mon, try it, capt'n! Przysięgam, że będzie działać!"
    chi "Przepraszam... Here we go..."
    kay "Niech mnie diabli. Nie tylko działa, ale wydajność wzrosła o 20 procent."
    asa "Mówiłam Ci, ona jest genialna!"
    chi "Ehehehehe..."
    kay "Uh, well okay then. Możesz rozpocząć naprawy tak szybko jak to tylko możliwe."
    ...
    ava "Chcesz nadzorować naprawy?"
    kay "Uhh, I think I'll leave you in charge of that. Będę w moich kwaterach, i spróbuję znaleźć sposób by opisać to wszystko w moim dzienniku ."
    ava "Zrozumiano kapitanie. Skontaktuję się z tobą gdy naprawy zostaną zakończone."

    scene bg black2 with horizontalwipereverse
    scene bg captainsoffice with horizontalwipereverse

    kay "Początek dziennika Kapitana. The Sunrider's been in dry dock for the past two days. Repairs have gone ahead of schedule and we're back to full combat status already. That Chigara girl really is something. I wouldn't mind having her in my engineering staff."
    kay "We're about to set sail again. Dalej nie jestem pewien co zrobić z naszymi dwoma gośćmi. Nawet jeśli Ava dalej im nie ufa, są dla nas bezcenną pomocą. Myślę, że poradziliby sobie dobrze na pokładzie Sunridera."
    kay "... ... ..."
    kay "Koniec dziennika Kapitana."
...
label firstpriority:
    ...
    ava "Statek jest do twojej dyspozycji, kapitanie."

    menu:
        "Jak myślisz - jaki powinien być nasz następny krok?":
...
label firstprioritytofindryders:
    ...
    ava "Najpierw najważniejsze. Like you said, the Sunrider's an assault carrier without any ryders. Our first priority should be to find pilots and ryders to fill up our empty hangar."
    kay "Mamy już jednego zainteresowanego pilota."

    show ava uniform armscrossed frown with dissolve

    ava "Powinieneś być z nią ostrożny. Asaga jest typem osoby, która szuka niebezpieczeństwa."
    kay "Skąd to wiesz?"
    ava "Kobieca intuicja."
...
label readytosetsailcommand:
    ...
    ava "Naprawy zostały już zakończone. Jesteśmy gotowi by wyruszyć, gdy tylko wydasz polecenie."
    menu:
        "Jak myślisz - jaki powinien być nasz następny krok?":
            jump firstprioritytofindryders
        "Trzymaj się, Ava.":
...
label howdidyoumeetChigara:
    ...
    asa "Me and Chigara go back pretty far. Myślę, że spotkałyśmy się jakoś pięć lat temu, kiedy jeszcze była dziewczynką. Mmm... Well, I think she was a refugee from a planet that was destroyed in a natural disaster. Anyways, I saw a bunch of these dirty guys scaring her in the middle of the street, so I stepped in and tried to scare them away."
    ...
    menu:
        "Miałaś szczęście, że była tam by cię ocalić!":
            jump luckyshewastheretosave
        "Więc ocaliłaś Chigarę?":
...
label eversincethencomrades:
    ...
    asa "I od tego czasu jesteśmy towarzyszkami broni!"
    kay "(It feels like she skipped a few chapters of that story...)"
    kay "(Still, a refugee from a doomed world? Może powinienem spytać o to Chigarę.)"
...
label aboutjoiningtheSunrider:
    ...
    menu:
        "Dlaczego chcesz dołączyć do Sunridera?":
...
label whatsgrudgeagainstPACT:
    ...
    asa "Mmm... Well, nothing as big as having my planet conquered by them. To jest... Uhh... Coś bardziej osobistego."

    show asaga plugsuit excited happy with dissolve

    asa "Tak czy owak powiedzmy, że robię to dla heroizmu!"
...
label tellmoreaboutpirates:
    ...
    asa "Terroryzowali ten sektor przez ubiegły rok. Kupców, żołnieży, nawet cywili. Nikt nie jest przy nich bezpieczny."
...
label youvegotadeal:
    ...
    asa "Nie martw się, nie martw! We'll whack those pirates in no time at all, and then attend to your PACT problem together."
    kay "Witam w zespole, Asaga."
...
label chigarafirstconvo:
    ...
    chi "E-eah! Oh, przepraszam Kapitanie Shield, nie widziałam jak przyszedłeś."
    ...
    if ChigaraRefugee:
        menu:
            ...
            "Gdzie nauczyłaś się tak pracować z maszynami?":
                jump wherelearnmachinelikethat

            "Dzięki Chigara. That'll be all for now.":
...
label youmadeblackjackyourself:
    ...
    chi "Zgadza się. Asaga used to pilot around a military surplus fighter that she put together from a junk heap. I used to be worried sick that it'd fall apart, so I decided that I'd build a new ryder for her."
    kay "The Black Jack's unlike anything I've seen in my life. Wiesz, jeśli pracowałabyś dla firmy inżynieryjnej mogłabyś zmienić galaktykę."

    show chigara plugsuitlabcoat holdingipad sad with dissolve

    chi "Ah... Ale wtedy nie byłabym w stanie otworzyć mojej piekarnii..."
...
label attackonpiratesnest:
    ...
    ava "Nawet z pomocą naszych nowych pilotów, atak nie będzie łatwy."
    ...
    kay "Problem za problemem…"

    show asaga plugsuit handsonhips happy with dissolve

    asa "Nie martw się, kapitanie! These pirates are cowards. They're only used to fighting unarmed civilians and ragtag freelancers. They'll be shakin' in their boots once they see the Sunrider barreling towards them!"
    ...
    kay "Sounds good. Ale skąd weźmiemy na to pieniądze?"

    show ava uniform handonhip neutral with dissolve

    ava "Misje. Jest całe mnóstwo ludzi w galaktyce, którym przyda się wyciągnięta pomocna dłoń. If we sort their problems out, usually through judicious application of our main cannon, then we can be paid in return."
    ...
    kay "W porządku. Przemyślę to i zobaczę co mogę z tym zrobić."
...
label meetsophita:
    ...
    ava "Kapitanie, mam dla Ciebie wiadomość."
    kay "What is it?"
    ava "I've received a message from the Mining Union. Wygląda na to, że są zainteresowani rozmową z Tobą."
    kay "Any thoughts on what they want from us?"

    show ava uniform alt neutral neutral with dissolve

    ava "The Mining Union is one of the biggest private corporations in the galaxy. Kontrolują prawie wszystkie etapu procesów górniczych, od the extraction of ores from the rock bed, to the refinement of those ores into starship grade steel. Last time I checked, the Mining Union provides the steel for nearly half the galaxy's navies."
    ...
    menu:
        ...
        "(Powróć do mapy statku)":
            jump dispatch

label FTLTransponderintro:

    menu:
        "(Zadzwoń do Sopita Brooks)":
            jump introsophita
        "(Wróć)":
            jump dispatch
...
label introsophita:
    ...
    sop "Kapitanie. I'm pleased to make your acquaintance.  I am Sophita Brooks, vice secretary of operations."
    kay "Kapitan statku kosmicznego Sunrider Kayto Shield. And to what do I owe the pleasure?"
    ...
    sop "Jeśli będziesz mieć pieniądze, dostarczymy te artefakty na twój osobisty użytek. I'm sure that you will find them to be most helpful."
    kay "Będę pamiętać."
    sop "Just remember, the Union will always be available to help - provided you have the money and the will."
    kay "Jedyne dwie siły w galaktyce większe niż każdy okręt wojenny."
    sop "Widzę więc, że jesteśmy po tej samej stronie."
...
label researchanddevelopment:
    ...
    chi "Welcome to research and development, captain. Czy jest coś w czym mogłabym ci pomóc?"

    menu:
        "Let me allocate our funds.":
            if not BM.seen_skirmish:
                chi "Very well captain. Pamiętaj, że możesz za darmo spróbować wszystkie ulepszenia w symulatorze."
            jump allocatefunds
...
label mission3:
    ...
    if check1 == False:
        ...
        chi "Pola energetyczne zapewniają ochronę przeciwko broniom bazującym na laserach dla wszystkich jednostek znajdujących się w oznaczonym na mapie niebieskim polu."
...
label after_mission3:
    ...
    ava "Captain, some of the traffickers have managed to survive on escape pods. They have dropped a distress beacon and are requesting relief. Jakie są twoje rozkazy?"
...
label leavethemtydarianauthorities:
    ...
    asa "But captain, these guys could just bribe themselves out of jail! Są zbyt niebezpieczni by dać im żyć!"
    ...
    chi "Asaga can get a little too excited at times, especially when people are being hurt. Cieszę się, że jesteś tutaj by trzymać ją na właściwej drodze, kapitanie."
...
label pactstationattack:
    ...
    kay "W porządku. Asaga, Chigara, are you ready down there?"
...
label mission4:
    ...
    if battle_check1 == False:
        ...
        ava "This is a hit and run operation, captain. Our primary objective is the destruction of the PACT spire. Wszystkie pozostałe jednostki są celami drugorzędnymi."
        kay "W porządku. All units, focus on the spire! Try to minimize combat with the escort fleet!"

        play sound "Sound/objectives.ogg"
        "Cel: Destroy the PACT Spire"
...
label after_mission4:
    ...
    asa "Zrozumiano, kapitanie! All wings are returning home. We did it!"
...
label piratebaseattack:
    ...
    ava "Alarm. Wykryto wrogów. Nadciąga flota piratów!"
...
label mission5:
    ...
    if battle_check1 == False and BM.turn_count == 5:
        ...
        cos "Co robicie, głupcy! Zabić ich!"
        kay "Nie tym razem, Cosette. Jesteśmy tu by zakończyć twoją działalność w tym sektorze."
...
label after_mission5:
    ...
    ava "Muszę przyznać Kapitanie, jestem pod wrażeniem. Perhaps we do stand a chance against PACT after all."

    menu:
        "Of course we do, Ava. To jest dopiero początek naszej historii.":
            jump onlythebeginningofstory

        "Don't let your guard down. Dalej mamy mnóstwo pracy przed nami.":
            jump stillworkahead

label onlythebeginningofstory:

    ava "I nie mogę się doczekać by zobaczyć jak będzie dalej."
...
label celebratehangar:
    ...
    ava "Dziewczyny powinny być w hangarze. Powinieneś iść świętować z nimi."
...
label celebratepiratebase_asa:
    ...
    asa "Eh-hehh... Jak obiecałam, będę zadowalona z dołączenia do Ciebie na Sunridera. If you've got a war against PACT, then sign me up!"
    kay "Dobrze to słyszeć. PACT's empire is still getting stronger with each day. Będziemy potrzebować każdej możliwej pomocy, jeśli chcemy ich zatrzymać."

    show asaga plugsuit vpose with dissolve

    asa "Understood, capt'n! Asaga Oakrun do twoich usług!"

    menu:
        "Jak myślisz co się stanie z piratami?":
            jump thinkwillhappenpirates
        "Co się stanie z Chigarą?":
            jump goingtohappenwithChigara
        "Let's move on. Musimy przydzielić Ci pokój na Sunriderze.":
...
label assignasagaroom:
    ...
    asa "Oh, by the way, I think Chigara's wanted to talk to you. Powinienieś z nią porozmawiać!"
...
label thinkwillhappenpirates:
    ...
    asa "Prawdopodobnie cofnęli się głębiej w niezakolonizowaną część kosmosu by się przgrupować i odbudować swoją flotę. Gdy to się stanie wrócą by się zemścić."
...
label goingtohappenwithChigara:
    ...
    asa "Oh! Powinienieś z nią o tym pogadać. Myślę, że mimo wszystko chce z Tobą porozmawiać."
...
label celebratepiratebase_chi:
    ...
    chi "Eh-heh... Naprawdę? I wonder..."
    kay "Jakie masz teraz plany?"

    show chigara plugsuit handstogether sad with dissolve

    chi "Umm... Well, I guess with Asaga gone, it's going to get more lonely."
    chi "I biznes również nie będzie taki dobry w piekarni jak kiedyś..."
    kay "Powinnaś również dołączyć do nas na Sunriderze. We could use an extra pilot like you."

    show chigara plugsuit palmsup surprise with dissolve

    chi "E-eh!? Naprawdę? Czy to jest dozwolone?"
    kay "Oczywiście, że jest. Jestem kapitanem."

    show chigara plugsuit handstogether smile with dissolve

    chi "Eh-heh... Well, I guess I don't really have a choice, do I? W takim razie jestem od teraz pod twoją opieką kapitanie."
    kay "Witam na pokładzie Sunridera, Chigara."
    kay "A teraz muszę już się zbierać. Możesz porozmawiać z Avą jeśli miałabyś jakiś problem z wprowadzeniem."
    chi "Zrozumiano, kaptanie. I look forward to working with you."
...
label chap2_start:
    ...
    ava "Kapitanie, właśnie otrzymaliśmy zaszyfrowaną transmisję."
    kay "Transmisję? Skąd?"
    ava "It's from the Solar Alliance. Admirał Harold Grey chce rozmowy z tobą."
    kay "Audiencja z admirałem, huh?  I didn't realize we were so important already."
    ava "I've added the Admiral's line to your FTL transponder.  You can patch him through now."
    kay "W porządku, posłuchajmy, czego Admirał chce od nas."
    ...
    kay "This is Captain Kayto Shields of the Cera Space Force. To jest moja Pierwsza Oficer, Ava Crescentia.  What would the admiral of the Solar Alliance want with us?"
...
label situationbetweenalliance:
    ...
    ava "Czego chcesz się dowiedzieć?"
...
label tellmorealliance:
    ...
    menu:
        ...
        "Dzięki za lekcję historii. To wszystko, czego potrzebowałem się dowiedzieć":
...
label jumphotversta:
    ...
    ava "Wait a minute... Alarm! Drop point is hot! I'm detecting PACT signatures all around us!"
    ...
    kay "Czerwony alarm! Scramble our ryders!"

    show asaga plugsuit excited happy:
        xpos 0.2
    with wipeup

    asa "We're ready at your command, capt'n! Daj rozkaz!"
...
label mission6:
    ...
    if check1 == False and BM.turn_count == 2:
        ...
        kay "Flag?"
        ava "Niezidentyfikowana... Nie pasuje do żadnych styli pirackich..."
...
label after_mission6:
    ...
    chi "Ah... Wygląda na to, że wygraliśmy."

    show ava uniform armscrossed frown with dissolve

    ava "Don't celebrate just yet. To było zbyt słabe by być główną siłą inwazji. To był tylko oddział zwiadowczy."
    kay "I teraz wrogowie wiedzą gdzie jesteśmy."
    ...
    asa "O-oh! Ona jest dziewczyną tak jak my, Chigara!"

    show icari plugsuit neutral neutral with dissolve

    ica "Czy to... a PACT vessel?"
    kay "Nie. Jestem Kapitanem Kosmicznych Sił Cery Kayto Shields. Witam na pokładzie Sunridera."

    show icari plugsuit armscrossed neutral with dissolve

    ica "Cera? I thought you were conquered by PACT."
    kay "Not all of us. Kim jesteś?"
    ica "Icari Isidolde. Private mercenary."
    kay "Were you hired by PACT?"

    show icari plugsuit armscrossed confident with dissolve

    ica "Heh... Nothing of the sort. Was on a mission. Nie mogę ci nic więcej powiedzieć."

    show ava uniform armscrossed frowntalk with dissolve

    ava "Teraz jesteś naszym więźniem. Put your hands up and turn over all your weapons."
    ...
    ava "We scanned through the database on her ryder and all of her electronics and found nothing. Ona nie jest amatorem."
    kay "W porządku. Spróbuję z nią porozmawiać."

    show icari plugsuit armscrossed frown with dissolve

    ica "Tsch. I sure hope you haven't dirtied up my ryder."
    kay "Nie musisz się tym przejmować. Dlaczego nie unikniesz tych wszystkich kłopotów dając nam kilka informacji?"

    show icari plugsuit handonhip lookawaysnide with dissolve

    ica "Heh, czego chcesz?"
    kay "Dlaczego nas zaatakowałaś? Are you working for PACT?"

    show icari plugsuit handonhip annoyedtalk with dissolve

    ica "Już ci mówiłam, nie pracuję dla tych fanatyków. Nie słuchałeś?"
    ...
    ica "Nie! Nienawidzę ich. I would have busted up their whole fleet back there."
    ...
    ica "Więc zamierzasz mi powiedzieć, co kapitan z Cery tutaj robi?"

    show ava uniform alt neutral angry with dissolve

    ava "To my zadajemy tutaj pytania, nie ty."

    show icari plugsuit handonhip snide with dissolve

    ica "Heh, co, nie jesteśmy tutaj by zostać przyjaciółmi?"
    ...
    ica "Heh, interesujące."
    kay "There, you have our secret. How about you tell me yours?"
    ica "... ... ..."

    show icari plugsuit armscrossed frown with dissolve

    ica "W porządku, kapitanie. You've made your point. If I tell you mine, you're going to have to promise not to lay a finger on my Phoenix. Oh, and also to get your damned housewife's scowl out of my face."

    show ava uniform armscrossed frown with dissolve

    ava "Hmph."
    kay "W porządku. I suppose we could lay off your ryder."
    ...
    kay "Znasz go?"
    ica "Znam go? Pracowałam dla niego wieki."
    kay "Co robiąc?"
    ica "Jak myślisz? If you want anything in this galaxy, you need some undesirables erased.  Oh, nothing terrible, mind you, the admiral's a pretty principled guy."
    ...
    ica "Misja ratunkowa? Is that what the Admiral told you?"

    show ava uniform armscrossed frowntalk with dissolve

    ava "If you know something, you better spill it."
    ica "Nie tak szybko.  That little information's gonna cost you.  Nothing big, mind you."
    ...
    kay "W porządku. If we're both against PACT, I'm interested in seeing what you have to say."
    ica "I may be an assassin, but I'm no scoundrel. Możesz polegać na moim słowie, kapitanie."
    ...
    kay "(This is a little hard to believe, but her hatred of PACT seems sincere.  Co powinienem zrobić?)"
    ...
    menu:
        ...
        "Nie wierzę Ci.  You can stay here in your cell while we perform our own investigation.":
...
label dontbelieveicari:
    ...
    kay "Niczego nie obiecywałem.  Ava, get our guest something to eat.  She'll be staying here for a while."
    ava "Zrozumiano."
...
label whattodoicari_ava:
    ...
    ava "She's getting comfortable. Odnośnie tego co powiedziała..."

    menu:
        "She's got a point. Sparking an Alliance-PACT war is the only way we can stop PACT.":
            jump pointwaronlyway

        "Jest oczywiście szalona. Skończymy naszą misję i uratujemy tych dyplomatów.":
...
label obviouslycrazysave:
    ...
    ava "Zgadzam się, że powinniśmy być z nią ostrożni. But given our situation, we should consider what she has told us."
    kay "Nie chcę mieć krwi cywili na moich rękach, Ava."
...
label consideringoptionsfornow:
    ...
    kay "Anyways, I'm still considering our options for now. Jaki jest nasz następny krok?"

    show ava uniform neutral talk with dissolve

    ava "I've made contact with the Alliance diplomats.  They're going to attempt to make an escape soon."
    kay "W porządku. Will we be bringing them aboard?"
...
label whattodoicari_asa:
    ...
    asa "Nie martw się, nie martw! Just leave it to me and mah Black Jack! We'll take care of the invasion fleet in no time!"
...
label whatdoyouthink:
    ...
    asa "No, no, no, capt'n! Nie możesz tego zrobić i pozwolić niewinnym umrzeć!"
...
label neverbeatpactalliance:
    ...
    asa "Ahh, don't be so down, capt'n! You have me and the Black Jack! Razem, możemy zrobić wszystko!"
...
label goodallocatefundinglater:
    ...
    chi "Zrozumiano, kapitanie"

    menu:
        "What's your take on what's going on with the mercenary?":
            jump yourtakemercenary
        "Dziękuję za twoją pracę. Do zobaczenia później, Chigara.":
...
label proceed_rescuediplomats:
    ...
    kay "Początek dziennika kapitana. We've made contact with the diplomats on Versta and are going to attempt an escape."
    ...
    ica "Relax captain. Nie jestem tu by poderżnąć Ci gardło, ani nic w tym stylu. Chcę tylko porozmawiać."
    kay "Tylko rozmawiać?"
    ...
    ica "Powiedz mi... Ilu ludzi umarło na Cerze tego dnia?"
...
label photoalbumlook:
    ...
    ica "Wygląda młodo. Nie wyglądasz jak ojciec. Więc myślę... twoja siostra?"
    kay "Stąpasz po cieńkim lodzie. I suggest you drop it."

    hide item with dissolve

    ica "What's the matter, captain? Czy trafiłam w twój słaby punkt?"
    ...
    ica "Wiem co to znaczy stracić rodzinę... Posłuchaj mnie kapitanie."
    ...
    kay "Co, jeśli powiem, że Ci nie wierzę?"
    ...
    kay "Admirał Grey? Funny you say that, considering he sent us here to protect the diplomats."

    show icari plugsuit armscrossed neutral with dissolve

    ica "Get with the program, captain.  Everyone in the Alliance military knows that war is inevitable."
    ica "Możesz teraz ocalić tych dyplomatów... And with each passing day, PACT will conquer one planet after another.  Millions more will lose their lives..."
    ...
    ica "Admirał Grey zrozumie to. That is why he hired me to ensure those diplomats never make it out of Verstra space."
...
label endafterwhat:
    ...
    menu:
        ...
        "W porządku. Wierzę ci. Pracujmy razem.":
...
label hatepactbackbrig:
    ...
    ica "Nie rozumiesz, kapitanie. PACT is evil. Nie przejmują się życiem niewinnych. We have to act now to stop them, before it's too late!"
    kay "We still have a duty to humanity on board this ship. Nie będę rozkazywał zabijania niewinnych."

    play music "Music/Battle_Against_Time.ogg"

    show icari plugsuit pistol angry with dissolve

    ica "Tsch... Więc wygląda na to, że nie pozostawiasz mi wyboru."
    ...
    kay "That mercenary's becoming a problem. Znaleźć ją i zatrzymać!"
...
label rightyouworktogether:
    ...
    kay "Muszę poinformować Avę o zmianach w planie. You should go back to where you're supposed to be now, and just play along for now."
...
label findherandstopher:
    ...
    ava "Uh... Uwaga! Massive PACT signatures detected!"
    ...
    kay "Czerwony alarm!  All hands, assume battle stations!"
    ...
    asa "I'm here, capt'n!"
    kay "Zmiana planów. Focus on defending the diplomats against the PACT fleet.  Keep your eyes out for the mercenary unit.  I have the feeling she'll be back to interfere with our mission."
    asa "Aye capt'n!"
    ...
    kay "Put her through."
    "Agamemnon" "It looks like the PACT fleet's going to make our escape complicated. Dobrze mieć cię po naszej stronie, Sunriderze."
    ...
    asa "Zrozumiano, kapitanie! Don't worry, we'll keep those children safe!"
...
label agreehelpicari:
    ...
    ava "Kapitanie. Prawie ukończyliśmy przygotowania do naszej misji eskortowej. Dyplomaci są bezpieczni w transportowcu cywilnym Agamemnon. I was just about to call you down here, in fact."
    kay "About that. Nastąpiła zmiana planów, Ava."
    ava "Oh?"
    ...
    ava "Zrozumiano, kapitanie. Zgodnie z normą obowiązującą na wojnie, poświęcenia należy czynić dla większego dobra Przekażę zatem twoje nowe rozkazy załodze."
    kay "Dziękuję, Ava."
    ...
    ava "Kontakt! Multiple warp signatures detected!  It's PACT!"
    ...
    ava "The PACT fleet has noticed us.  A squadron of ships has broken off to intercept. Time until in range: Dziesięć minut."
    ava "Otrzymaliśmy wiadomość od Agamemnona. Powinnam otworzyć kanał?"
...
label agaputmethrough:
    ...
    ava "Aye captain."
    "Agamemnon" "Co robisz!?  I thought you were supposed to be our escort!"
    kay "Zmiana planów.  It seems like your leaders no longer wish to see you alive."
    "Agamemnon" "What do you mean...?"
    kay "Your sacrifice is necessary to stop PACT and save the lives of billions."
    "Agamemnon" "Co? What is this nonsense you're spurting!?"
    "Agamemnon" "Czekaj-- you mean to sacrifice us to spark a war... Oczywiście...!"
    kay "I hope you understand your position."
    "Agamemnon" "Nie... You cannot possibly do this to us!  Not when we..."
    "Dziewczynka" "Co się dzieje? Dlaczego wielki statek nas nie chroni?"
    kay "Co do-  Agamemnon, did I just hear what I think I did?"
    "Agamemnon" "Mamy tutaj sześćset dzieci na pokładzie statku, Sunriderze!"
    ...
    ava "Captain, we are getting underway. Jakie są twoje rozkazy?"
    "Agamemnon" "Without your protection, our act of charity will instead doom the children!"
    "Agamemnon" "Proszę, pomóż nam!"
    kay "(Sześćset dzieci? There was no way to have foreseen this!)"
...
label maintainpreparethroughpact:
    ...
    kay "W porządku, Icari. Help us break through the PACT fleet and you will have earned our trust."
...
label cancelwarpagaout:
    ...
    ava "Aye captain. Zmiana kursu. Weźmiemy Agamemnona pod nasze skrzydła."

    show asaga plugsuit excited focushappy:
        xpos 0.2
    with dissolve

    asa "W porządku! Let's go and kick some PACT ass! Haha!"

    show chigara plugsuit excited determined:
        xpos 0.8
    with dissolve

    chi "Jestem gotowa, kapitanie!"
    kay "All ryders, launch!"
...
label after_mission7:
    ...
    asa "Czekaj! Wykrywam Agamemnona na skanerze!"
    ...
    ava "Utraciliśmy kontakt z Agamemnonem!"
    kay "... ... ..."
    ...
    kay "Yeah."
    "Odwrócił się i wziął do rąk ramkę ze zdjęciem swojej siostry."
    ...
    ica "I was just... dazed, that's all. A-also, I keep onions in my cockpit. C-co, nie wierzysz mi? To prawda!"

    show icari uniform armscrossed sad with dissolve

    ica "... ... ..."
    ica "Tsch."
    ica "I saw a girl on that ship. I to przypomniało mi..."
    ...
    ica "They all deserve to die for what they did that day... I've spent my whole life trying to avenge my family. I nie zatrzymam się teraz."
    kay "... ... ..."
...
label mission8:
    ...
    if ep2_cancelwarp == True:
        ...
        ava "Za późno! She's already out of our range."
        kay "Wszystkie jednostki. Icari has escaped on the Phoenix. Keep your eyes open for her. No doubt she intends to interfere with our mission."
    ...
    if check1 == False:
        ...
        play sound "Sound/objectives.ogg"
        "Cel: Bring the Agamemnon to the far right edge of the map."
    ...
    if check4 == False and BM.turn_count == 6:
        ...
        ica "Wojna nie może być wygrana bez poświęceń. Sprawiedliwi tacy jak wy są ślepi na rzeczywistość!"
...
label after_mission8:
    ...
    ica "... ... ..."
    ica "Zrozumiano. Phoenix, returning."
    ...
    kay "Donra robota, Asaga. I admit, I was starting to sweat pretty heavily there."
    ...
    ava "I've apprehended the mercenary. Co powinniśmy z nią zrobić?"
    ica "... ... ..."
    kay "Well, I guess it's better being one of the good guys after all, huh Icari?"

    show icari plugsuit armscrossed tsun with dissolve

    ica "Co? I-it's not like I wanted to help you out or anything! I just felt bad about those kids..."

    show icari plugsuit armscrossed sad with dissolve

    ica "... ... ..."
    ica "Ale... I guess I was wrong. For just a moment there, I would actually have done it."
    ...
    ica "W porządku... You have a deal. I'll help you defeat PACT... and in exchange, I'll play by your rules."
    ...
    chi "Ah... W-witaj w zespole, Icari... Eh-heh..."
    chi "Let's try to get along well from now, alright? No more fighting..."

    show asaga plugsuit handsonhips happy with dissolve

    asa "Ah well, now that that's over, let's grab some grub! Jestem głodna!"
    ...
    asa "Haahhahahaha! C'mon capt'n! Dołącz do mnie i Chigary! We have so much to talk about!"
    kay "Well Ava, looks like you'll be taking a break. I Icari, ty też."
...
label ep3_start:
    ...
    python:
        ...
        try:
            ...
            pass
#            show_message('debug: Błąd przy usuwaniu agamemnona. Może już go nie ma.')
    ...
    ava "Jestem zaskoczona, że pamietasz. To było tyle lat temu."
...
label someonekeepouttrouble:
    ...
    kay "Oczywiście. You were always trying to solve other people's problems. To tylko kwestia czasu, zanim zranisz samą siebie."
    ava "Heh. W porządku, nie będę temu przeczyć."
    ...
    ava "Masz rację. I did try too hard. And in the end, I just left disappointed."
...
label thenthingsdifferent:
    ...
    ava "Zrozumiano. I'm your first officer before anything else, captain."
...
label everthinkcaptainsseat:
    ...
    ava "... ... ..."
    ava "Nie."
    ava "Jestem twoją pierwszą oficer. There's nothing more to it than that."
    ava "Wykonuję twoje rozkazy, kapitanie. That's all there is to it."
...
label highschooldayslaugh:
    ...
    ava "... ... ..."
    ava "Hahahaha."
    kay "Co? Co jest takiego śmiesznego?"
    ava "Spójrz na mnie. We're in the middle of a war, and here I am, reminiscing about high school."
...
label guessjustmoveonthose:
    ...
    menu:
        "Zabijemy Veniczara za to. It's the only way justice can be done.":
...
label killveniczaronlyjustice:
    ...
    menu:
        ...
        "Dzięki za rozmowę. Powinienem wracać do pracy.":
            jump thankschatback
...
label whatswronggamecard:
    ...
    kay "Nie, Ava… You know that military protocol doesn't mean much now that Cera's a PACT colony."
    ...
    kay "W porządku… Just don't push yourself too hard, alright? Relax every now and then."
    ava "Zrozumiano, kapitanie"
...
label alreadyspokeavano:
    ...
    kay "Właśnie o tym rozmawiałem z Avą. She won't be giving you any more trouble."

    show asaga uniform excited grin with dissolve

    asa "Naprawdę? Ahaha, you're the best, capt'n!"
    ...
    menu:
        ...
        "Powinienem iść. Try to stay out of trouble, Asaga.":
            jump gostaytroubleasaga
...
label ep3_chitalk:
    ...
    chi "Czy jest coś czego potrzebujesz, kapitanie?"
...
label howchiajustsunrider:
    ...
    chi "C-czy możesz proszę powtórzyć pytanie?"

    menu:
        "Spokojnie, Chigara. I was just asking how you were doing.":
...
label calmchigaraaskingdoing:
    ...
    chi "Pierwsza Oficer pomogła mi wnieść wszystkie moje rzeczy. I even managed to improve the research lab here in engineering too."
...
label whatchimercenary:
    ...
    if Saveddiplomats == False:
        ...
        chi "To było przerażające widzieć jak te wszystkie dzieci giną..."
        chi "I..."
        chi "To nie był pierwszy raz, kiedy widziałam jak coś takiego się dzieje. Ale nigdy się do tego nie przyzwyczajasz."
        chi "I guess it's unavoidable that innocents die in war."
        chi "To dlatego lubię maszyny. Możesz je naprawić nawet jeśli jeśli się zepsują."
...
label soundsbarbaric:
    ...
    ica "Heh. Prawdziwy świat jest inny niż szkoła oficerska, kapitanie. A lot less clean."
    jump stillmostfaces
...
label missionfromryuvians:
    ...
    kay "Greetings, your highness. Jestem Kaptian Kayto Shields statku kosmicznego Sunrider. This is my First Officer, Ava Crescentia."
...
label moneyhelpcrownback:
    ...
    ava "Zrozumiano kapitanie. I've punched in the coordinates for the Nomodorn Corridor. Just set our course on the star map and we'll be underway."
...
label jumptonomodorn:
    ...
    kay "Czerwony alarm! Wznieście tarcze i zasilcie broń! Ready all ryders for combat!"
...
label oldfriendcosettetail:
    ...
    kay "Nasza stara przyjaciółka Cosette Cosmos może tam być. Watch your tail, everyone."
    kay "W porządku! All units, launch!"
...
label mission9:
    ...
    if check1 == False:
        ...
        play sound "sound/objectives.ogg"
        "Cel: Protect the civilian transport."

        if Saveddiplomats == True:
            "Podpowiedź:  The Phoenix can briefly become immune to blindside attacks by going into stealth mode."
    ...
    if check2 == False and BM.turn_count == 3:
        ...
        cos "Hahahaha! Nie wygrasz tym razem! We even brought in our friends from PACT!"
        ...
        kay "W porzadku, Claude. The Sunrider is at your service. Let's get these bogies off of you."
        play sound "sound/objectives.ogg"
        "Nowy cel: Pokonaj wszystkich wrogów."
...
label after_mission9:
    ...
    cul "Głupcy! Co robicie!? How could you let yourself be beat by a single ship!?"
    kay "Looks like today's not your day, Veniczar Porkchops."
    cul "T-tsch... Jak śmiesz! I will not stand for this mockery!"
    ...
    kay "Witamy na pokładzie Sunridera."
    ...
    cla "M-mój kapitan w lśniącej zbroi..."
...
label youlooksoyourself:
    ...
    cla "Ahahaha, oh my. It's still too soon to be flirting with your damsel in distress, capt'n. Zwłaszcza z hangarem pełnym innych kobiet, które patrzą."

    show ava uniform facepalm:
        xpos 0.7
    with dissolve

    ava "Kapitanie! Just please get to business already! Arggghh!"
...
label dubious_credentials:
    ...
    kay "Dziwne. Być może jest licencjonowana w innej organizacji medycznej?"

    show ava uniform handonhip neutral with dissolve

    ava "Możliwe. Despite the AMA being the most reputable, many neutral planets run their own medical licensing schemes."
...
label medical_examination:
    ...
    chi "... ... ..."
    kay "Chigara? Wszystko z tobą w porządku? Nie wyglądasz zbyt dobrze..."

    show chigara uniform handsup surprise with dissolve

    chi "O-oh! K-Kapitanie..."

    show chigara uniform twiddlefingers forcedsmile with dissolve

    chi "T-to nic... I... was just here for my medical exam..."
    ...
    chi "O-oh tak... C-checked..."

    show chigara uniform handonchest sadblush with dissolve

    chi "... ... ..."
    chi "Ja... Myślę, że powinienem teraz iść."
    kay "W porządku."
    ...
    cla "Oh kapitan! Czekałam na ciebie!"
    ...
    ava "UWAGA: This individual is known to masquerade as a medical practitioner. Her skills fall below all reasonable standards of modern medical care. Patients are advised to seek the advice of a professional medical practitioner instead of this individual."
    kay "I-I knew it!"

    show ava uniform salute angry with dissolve

    ava "Rozkazy, kapitanie!?"
    ...
    kay "(I molestowanie kapitana statku kosmicznego!)"
    ...
    ava "Kapitanie, zamknęłam w areszcie naszego \"lekarza\". Co powinniśmy z nią zrobić?"
    kay "Send a transmission to the Alliance. We'll just turn her over to the authorities."
    cla "{i}Szloch... Szloch...{/i}"
    kay "... ... ..."
    ...
    cla "{i}Szloch...{/i} If you're looking for Ryuvian treasure, the place you're looking for is the Mnemosyne Abyss."
    ...
    menu:
        ...
        "Get her to the hangar. Będzie bardziej użyteczna jako pilot niż lekarz.":
...
label hangarusefulpilotdoc:
    ...
    ava "Nie wiarygodne... Come on, the hangar's below us."
...
label jumptograveyard:
    ...
    kay "Kto wie? Maybe we might also find lost technology which can make the Veniczar magically disappear."
    ...
    ava "Odczytuję... Coś dziwnego na skanerze."
    kay "Dziwnego?"
    ...
    asa "We're ready down here, capt'n! Jakie są twoje rozkazy?"
    ...
    asa "Zrozumiano, kapitanie! Alright, you heard the man! All units, launch after me!"
    ...
    asa "Uh oh!"
    kay "What did you do!?"
    asa "N-nothing! Przysięgam! The thing just came to life on its own!"
    ...
    ava "Uwaga! All the Ryuvian vessels have powered up!"
    ...
    kay "Czerwony alarm! All hands, battle stations!"
    ...
    ava "Straciliśmy kontakt z Asagą!"
    kay "What in hell's-"
    ...
    if ClaudeConfine == True:
        ...
        kay "...W porządku. Doesn't look like we have much of a choice."
...
label mission10:
    ...
    if check1 == False:
        ...
        "Podpowiedź: Take cover in the wreckage to avoid enemy attacks."
...
label after_mission10:
    ...
    sol "Niemożliwe... There cannot be another... And..."
    ...
    kay "W porządku. Stand down red alert."
    ...
    sol "... ... ..."
    kay "Jestem kapitanem Kayto Shields. Witamy na pokładzie Sunridera."
    sol "You... are the leader?"
    kay "What's your name?"

    show sola plugsuit handonchest neutral with dissolve

    sol "Ja... Ja jestem Księżniczka Sola vi Ryuvia."
    kay "K-Księżniczka!? Are you the Princess who's been missing from Ryuvia all this time?"

    show chigara plugsuit palmsup surprise:
        xpos 0.2
    with dissolve

    chi "Nie... To jest niemożliwe!"
    chi "Sola vi Ryuvia nie żyje od dwóch tysięcy lat!"
...
label enoughryuvianknownjewel:
    ...
    cla "O-oohh... To... się świeci!"
    sol "Tak. The talbur illuminates in the presence of the royal family."
    ...
    kay "Damn! Bez chwili spokoju!"
    kay "C'mon people, return to battle stations!"

    scene bg bridgered with dissolve

    kay "Jaki jest nasz status!"
    ...
    ava "Czterdzieści - nie... sześćdziesiąt statków, kapitanie! I-it's an entire fleet!"
    ...
    menu:
        ...
        "W porządku. Ale w zamian, obiecasz mi bezpieczeństwo dla mojej załogi.":
            jump exchangepromisesafety

label jewelcolddead:

    cul "Tsk. I was afraid it would come to this."
    cul "Men! Otworzyć ogień! Perhaps a little show of force will mellow out this boggart!"
...
label exchangepromisesafety:
    ...
    cul "Masz moje słowo! Your crew shall not come to harm!"
    kay "Tsch."
    "... ... ..."
...
label porkfleetopenfire:
    ...
    ava "J-Jest ich zbyt wiele, kapitanie!"
    ...
    kay "(Czy to już koniec...?)"
    kay "(... ... ...)"
    ava "K-Kapitanie!? T-twoje rozkazy!?"
    ...
    kay "T-tsch..."
    kay "(Nie... To nie jest nasze pożegnanie...)"
...
label chap4_start:
    ...
    cul "Tu jesteś, moja księżniczko. Zaczynałem się bać, że znów cię straciłem!"
    ...
    cul "Tak długo jak jesteś na pokładzie mojego statku, należysz do mnie. Muufufufu..."
    ...
    asa "Ty jesteś... Veniczar Fontana."
    ...
    ava "...naprawy na statku są na ukończeniu, kapitanie. We've been working around the clock to patch her back together after that last assault."
    ...
    kay "Asaga jest członkiem naszej załogi. I'm not going to abandon her."
    ...
    ava "Zrozumiano, Kapitanie. Ja... will be in my quarters, readying the battle plans."
...
label sorryfordeceiving:
    ...
    chi "Ah... kapitanie."
    kay "Chciałaś mnie widzieć?"

    show chigara uniform handstogether sad with dissolve

    chi "Tak. Um... I don't think I've ever apologized to you for lying to you all this time about Asaga."
    ...
    menu:
        "Po prostu próbowałaś chronić Asagę. Apology accepted.":
...
label secretsdangerlie:
    ...
    chi "Tak kapitanie. Przyrzekam, że nie zrobię tego nigdy więcej."
    jump shockfirstfoundryuvia
...
label shockfirstfoundryuvia:
    ...
    menu:
        "Jak odkryłaś, że Asaga jest księżniczką?":
        ...
        "To będzie nasza najtrudniejsza dotychczasowa misja. Przygotuj się, Chigara.":
...
label howfindasagaprincess:
    ...
    chi "To było dawno temu, kiedy pierwszy raz spotkałam Asagę, lata zanim ktokolwiek z nas znał imię Arkadiusa."
    ...
    menu:
        ...
        "Twoja wstążka do włosów może zrobić coś takiego!?":
...
label hairribboncando:
    ...
    chi "Tak, kapitanie... It's actually one of my inventions, you see..."
...
label shortlyaftertruereally:
    ...
    menu:
        "PACT is nothing more than a tyrannical regime led by a madman. Veniczar Arcadius will never honor a political alliance with Ryuvia.":
            jump pacttyrannicalmadman
        "To będzie nasza najtrudniejsza dotychczasowa misja. Przygotuj się.":
            jump goinghardestyet
...
label pacttyrannicalmadman:
    ...
    kay "Nie martw się, Chigara. We'll go in there and rescue Asaga before the Veniczar can even lay a finger on her."
...
label goinghardestyet:
    ...
    chi "Tak, kapitanie. Zrobię wszystko co w mojej mocy, by ocalić Asagę od Veniczara!"
    kay "Dobrze. We'll be counting on your expertise to pull this off."

    show chigara uniform altneutral neutral with dissolve

    chi "One more thing, captain. Asaga mi to dała."
    kay "A holo recording?"
    chi "Powiedziała mi, by dać ci to, jeśli coś takiego by się wydarzyło.. With everything that's been going on, I couldn't give it to you until now."
    chi "Obiecałam jej, że nie będę go oglądać, więc to jest tylko dla ciebie."
    kay "Dzięki. Zobaczę go w moim biurze."
    chi "Dziękuję kapitanie."
...
label Asagarecording:
    ...
    kay "(Odtwórzmy to nagranie i zobaczmy co Asaga chciała powiedzieć.)"

    show asaga uniform neutral funnysmile with dissolve

    asa "Ah. Czy to coś się włączyło? Halo? Halo? Słychać mnie?"
    kay "(You know, you could have edited this part off, Asaga...)"

    show asaga uniform altneutral content with dissolve

    asa "Kapitanie? Naprawdę mam nadzieję, że to ty to słuchasz. If you're playing this message, then it means that I've left the Sunrider and probably on route to Ryuvia."

    show asaga uniform altneutral sad with dissolve

    asa "Na początku, pozwól mi przeprosić, bo bardzo mi przykro za oszukiwanie cię! Nie chciałam cię okłamywać przez cały ten czas!"
    asa "Myślałam, że to naprawdę się uda. That we could just travel the stars forever and beat PACT in the ass for good measure."
    asa "Ale... I guess you've gotta wake up from all dreams eventually."
    asa "When the time comes and I go back to Ryuvia..."
    asa "Please don't come after me."
    asa "Even though I don't agree with it... Mój ojciec ciągle postępuje właściwie."
    asa "Without the royal marriage, what happened at Cera will happen again at Ryuvia."
    asa "Miliony ludzi zostanie zabitych. Worse, what little remains of our way of life will be destroyed."
    ...
    asa "Jeśli tak jest ... to chętnie zostanę żoną Veniczara!"
    ...
    asa "Things like this have occurred throughout our history. Jestem... gotowa do odegrania mojej roli, nawet jeśli nie jest taką, jaką bym chciała!"
    ...
    "... ... ..."
    kay "(Nie Asaga... Idziemy po ciebie.)"
    kay "(Wiesz, że Veniczar oszukuje króla! PACT will never honor an alliance with Ryuvia!)"
...
label sol_intro:
    ...
    kay "Uwierz mi, jesteś ponownie wśród żywych."

    show sola uniform altneutral neutral with dissolve

    sol "Życzysz sobie czegoś ode mnie?"
    ...
    menu:
        ...
        "Tell me more of your time.":
            jump tellmoretime
        "Your eye was glowing during the battle. Co to było?":
            jump eyeglowingthat
        "Potrzebujemy pomocy. The technology of your time far surpasses our own. Pomóż nam ocalić naszą przyjaciółkę.":
...
label whatsoladoingnow:
    ...
    sol "... ... ..."
    sol "Nie wiem."
    sol "Świat jaki znałam, już nie istnieje."
    sol "The war against the Fallen is long concluded, and history no longer even remembers who the victors were."
    sol "Wszystko, co przysiągłam chronić, jest już dawno martwe lub zniszczone."
    sol "Żyję teraz pustą egzystencją."
    sol "Chcę raz jeszcze zamknąć oczy i zniknąć w nicości. As it was meant to be."

    menu:
        "Twoja historia jeszcze się nie zakończyła. Nowi wrogowie rzucają wyzwanie Ryuvii. Musisz podnieść miecz ponownie i walczyć.":
            jump storynotchallenge
        "Znajdziesz tu z nami nowych przyjaciół. You can rebuild your life.":
            jump newhererebuild
...
label newhererebuild:
    ...
    sol "... ... ..."
    sol "Przyjaciół?"
    kay "Jak rodzina ale połączona nie krwią, a więźmi."
...
label tellmoretime:
    ...
    sol "To jest broń o niewyobrażalnej sile. Yet, it can only be helmed by one of the King's daughters."
...
label eyeglowingthat:
    ...
    kay "Nie widziałem niczego takiego nigdy szybciej."
    ...
    menu:
        ...
        "Tell me more of your time.":
            jump tellmoretime
        "Potrzebujemy pomocy. The technology of your time far surpasses our own. Pomóż nam uratować naszą przyjaciółkę.":
            jump helptimeourfriend
...
label helptimeourfriend:
    ...
    sol "Obecną księżniczkę?"
    kay "Ryuvia potrzebuje twojej pomocy."

    show sola uniform backturn neutral with dissolve

    sol "This timeline is not my own. Wasze walki nie są moimi."
    ...
    sol "Będę broniła Ryuvii swoim życiem. I have already cast down my body for Ryuvia once, and I do not flinch at the thought of doing so again."
...
label goingalivethere:
    ...
    sol "A teraz ... żegnaj, kapitanie. Zostaw mnie w spokoju."
...
label recordingnotfollow:
    ...
    menu:
        "Looks like Claude's going to stay on board for awhile longer.":
            jump claudestayonboard
        "Dzięki Ava. I'll keep you posted on additional developments.":
            jump postedthanksdevelopments
...
label icecreamclaude:
    ...
    cla "Oh kapitan... Care to join me for some ice cream?"
    kay "W porządku, mam trochę czasu na rozmowę."

    show claude uniform neutral smallsurprise with dissolve

    cla "Czekoladowe czy waniliowe? A może po prostu chcesz zjeść z mojej miski--"
    kay "Uh... nie dzięki."

    menu:
        "Czy flirtujesz z każdym jednym kapitanem kosmicznym, którego spotkasz, Claude?":
...
label flirtcaptainmeet:
    ...
    cla "Eh-heh... Tylko z tymi słodkimi---"
    kay "Uh, w porządku. Przepraszam, że zapytałem."

    show claude uniform handstogether puppy with dissolve

    cla "What's the matter, capt'n? Nie uważasz, że Claude jest słodka?"
    ...
    menu:
        ...
        "Jasne... Ale Ava będzie mnie ścigać z łańcuchami, jeśli zobaczy mnie ze tobą.":
...
label captainserioushurt:
    ...
    cla "Nuuuuuuddaaaa..."
    kay "Obawiam się, że nigdy nie byłem typem porywającego kapitana kosmicznego."

    show claude uniform fingerup neutral with dissolve

    cla "Mmm... Nie byłabym tego taka pewna."
    kay "Co?"

    show claude uniform altneutral lookawaykitty with dissolve

    cla "Eh-heh... Właściwie, to przyłapałam dziewczynę w pomieszczeniach inżynieryjnych, oglądającą zdjęcia, które zrobiła ci pewnego dnia. Czy na pewno nie masz wielbicielki?"
    kay "Zmyślasz."

    show claude uniform excited heartdrool with dissolve

    cla "Dlaczego bym miała? Besides, I'd like to keep you all for myself, capt'n--"
...
label sureavachainssaw:
    ...
    kay "Chodziliśmy razem do liceum, to wszystko. We used to be pretty close back in the days, but it's not like we were dating or anything."
    kay "Chyba zawsze była bardziej jak starsza siostra."

    show claude uniform fingerup happy with dissolve

    cla "Haha. I teraz jest twoją pierwszą oficer? That's awkward!"
...
label whatgoingnow:
    ...
    cla "Mój statek został zniszczony przez piratów, więc wygląda na to, że utknęłam tutaj."
    ...
    kay "W porządku. Tylko... uhh..."
    kay "Nigdy więcej egzaminów medycznych."

    show claude uniform excited concern with dissolve

    cla "Oh but captain! To dla twojego zdrowia!"
...
label avatcausingproblems:
    ...
    menu:
        "Wiem, że Ava może być czasami frustrująca,ale ona tylko wykonuje swoją pracę. Can't you two at least try to get along?":
            jump suddenzzz
...
label suddenzzz:
    ...
    cla "I think I've been hit with a sudden sleep spell. Dobranoc!"
    cla "Zzzzzzz..."
    kay "Claude?"
    cla "Zzzzzzz...."
    kay "Przestań się wygłupiać."
    cla "Zzzzzzz...... Mmm..."
    kay "Twoje lody się topią..."
    cla "Mmm... Nom..."
...
label operationweddingcrash:
    ...
    fon "Mój Veniczarze. Witam w Ryuvii."

    show arcadius altneutral with dissolve

    arc "... ... ..."
    arc "Ten świat był kiedyś centrum ludzkości."
    ...
    arc "Tak jak w przeszłości dawni cesarze Ryuvian, będziemy trzymać galaktykę na dłoniach. But it will not be around the halls of the ancient Star Palace that the galaxy revolves, but from our mighty fortress at New Eden!"
    asa "Nie, jeśli cię zatrzymam!"
    ...
    arc "Teraz twoje życie należy do nas. Twoje ciało jest nasze. Your soul will be crushed, until you are but an obedient dog, eagerly licking her master's boots."
    asa "Nigdy!"
    ...
    ryu "Drodzy goście. We are gathered here to witness the marriage of the righteous Veniczar S. Arcadius to my lovely daughter, Princess Asaga di Ryuvia."
    ...
    asa "Ja........"
    asa "... ... ..."
    ryu "Zatem oświadczam, że jesteście mężem i żoną. Możesz teraz pocałować pannę młodą."
    asa "... ... ..."
    ...
    ryu "Co? Mieliśmy umowę, Veniczar!"
    ...
    asa "Ty! Wiedziałam, że to wszystko podstęp!"

    show arcadius altneutral with dissolve

    arc "Cisza, nasza mała księżniczko. You shall learn to serve us."
    ...
    arc "Hah. You speak too much. Żegnaj, mój królu."
    ...
    asa "Ojcze!"
    ryu "Asaga... Przykro mi."
    ryu "To była... Jedyna droga... The Veniczar promised your safety if you would wed him..."
    ...
    asa "Nie! Let me go!! Zapłacisz za to, Veniczar!!"
    ...
    kay "Rozpocząć operację! Launch our drones and take out the guard ships!"
    ava "Aye captain."
    ava "I will lead the security squad as planned. Ty masz mostek kapitanie."
    kay "Nie. Idę z tobą."
...
label theweddingcrash:
    ...
    cul "Disrespectful little whelp! Pokażę ci, ty mała-"
    ...
    cul "T-ty! Powinienem cię zabić, gdy miałem okazję!"
    ...
    asa "Ostrożnie kapitanie! Two, up in the rafters!"
    ...
    arc "Głupcy! Nie pozwólcie księżniczce uciec!"

    show cg_crosshairs with dissolve

    ava "Sola, wyeliminuj cel."
    sol "Zrozumiano."
    ...
    sol "Cel zneutralizowany."
    kay "Ava, potwierdź! Cel zdjęty?"
    ...
    kay "Damn!"
    kay "Abort mission! Get out of there! Powrót na Sunridera!"
    ava "Zrozumiano kapitanie. We're falling back!"
    ...
    asa "Kapitanie..."
    asa "Przyszedłeś po mnie. Even after..."
    kay "Of course I did. Jesteś członkiem mojej załogi."
    ...
    kay "Dobrze mieć cię z powrotem."
    kay "Now go get 'em."
    ...
    fon "Sir, the Sunrider is attempting to escape behind the first moon. We've already scrambled all our forces to intercept. Jakie są twoje rozkazy?"
...
label mission11:
    ...
    if check1 == False:
        ...
        play sound "Sound/objectives.ogg"
        "Cel: Sink the two PACT battleships."
    ...
    if battleships_remaining == 0 and check5 == False:
        ...
        play sound "Sound/objectives.ogg"
        "Cel: Get the Sunrider to the far right edge of the map."
...
label after_mission11:
    ...
    kay "Dobrze. Stand down red alert."

    scene bg bridge
    show ava uniform armscrossed smile
    with dissolve

    ava "That was one hell of a rescue, captain. Prawdę mówiąc, nie mogę uwierzyć, że udało nam się z tego wyjść cało."
    kay "Świetnie ci poszło, Ava. Wiedziałem, że mogę na ciebie liczyć."

    show ava uniform salute neutral with dissolve

    ava "Dziękuję, Kapitanie."
    ...
    ava "Zrozumiano, kapitanie. Setting course for the Alliance planet of Far Port. ETA: 18 hours."

    scene black with screenwipe
    scene bg captainsoffice with screenwipe

    kay "Początek dziennika kapitana. We've arrived at the Alliance world of Far Port. News of Ryuvia's fall has spread throughout Alliance space like wildfire."
...
label asagaafterrescue:
    ...
    asa "Musisz mieć wiele pytań."

    show asaga uniform altneutral sorryblush with dissolve

    asa "Po pierwsze przepraszam, że cię okłamałam. I didn't mean to place the crew in danger like that."

    show asaga uniform altneutral sadblush with dissolve

    asa "Chyba ... Byłam po prostu naiwna. Myślałam, że do końca życia będę mogła udawać, że jestem Asagą Oakrun. Zgaduję, że prawdziwe życie tak nie działa..."
    kay "Teraz to nie ma znaczenia. Cieszę się, że wróciłaś."

    menu:
        "Widziałaś, jak ginie twój własny ojciec. Dobrze się czujesz?":
            jump sawfatherkilled
        "Musisz wiedzieć coś więcej o Arcadiusie. Czy jest coś co możesz mi o nim powiedzieć?":
...
label fallofryuvia:
    ...
    sol "Stało się najgorsze. Ryuvia has fallen."
    kay "Jeszcze nie. Królowa wciąż żyje. We'll liberate Ryuvia and free your people."
    ...
    sol "Zostaw mnie. Życzę sobie samotności."
    kay "W porządku."
    sol "... ... ..."
    kay "Nie musisz być sama, Sola. Jesteśmy tu wszyscy dla ciebie."
    sol "Żegnaj."
...
label chigarathankrescue:
    ...
    chi "Jako jej przyjaciółka, wiele dla mnie znaczy, co dla niej zrobiłeś..."
    kay "Oczywiście musieliśmy ją uratować. Asaga jest członkiem naszej załogi."

    show chigara uniform handonchest closedeyessmile with dissolve

    chi "Eh-heh. Cieszę się, że jesteś naszym kapitanem... Kapitanie."
    ...
    chi "Proszę, przyjdź do mojego laboratorium, kiedy będziesz czegoś potrzebować, kapitanie."
    ...
    kay "O-oh. Ja, uh...nie wiedziałem, że to zrobiłaś."

    show chigara uniform handonchest sad with dissolve

    chi "To jest niedozwolone?"
    kay "Well, I'm sure it's fine. Just, uh... don't let Ava find out about it."

    show chigara uniform handstogether smileblush with dissolve

    chi "Tak kapitanie. Może mogłabym przetestować na nich mój nowy kompozyt z kamuflażem..."
...
label icarithoughtsalliance:
    ...
    menu:
        "Of course we had to pull it off. Asaga jest członkiem naszej załogi.":
            jump pulloffcrew
...
label pulloffcrew:
    ...
    ica "Heh. Pewnego dnia, kapitanie, twoje serce cię zabije. Mam tylko nadzieję, że kiedy to się stanie będę tam, by uratować ci tyłek."
    kay "To serce jest powodem, dla którego jesteś na pokładzie tego statku, Icari. Wiesz, robienie rzeczy słusznych oraz czerpanie korzyści nie wyklucza się nawzajem. You can stand for what's right and still make it out alright."
    ica "W porządku, kapitanie."
...
label truthsurprisedthere:
    ...
    ica "Haha, just don't go around looking so unconfident in front of the crew. Wiesz, krążą nawet o tobie plotki."
    kay "Jakie plotki?"
    ica "Haven't you been checking the holonet? You've just rescued the Ryuvian princess. Ludzie zaczynają zwracać uwagę na to, co robiłeś."
    ica "The more things are looking like it's going down the chute, the more people want to rally around a leader. Upewnij się więc, że spełniasz oczekiwania, w porządku?"

    menu:
        "Robię tylko to, co jest dobre dla galaktyki, Icari. I'm not in this for the attention.":
...
label needsagainsteverything:
    ...
    ica "W takiej sytuacji lepiej spraw sobie nowy garnitur. From the look of things, you'll be in the limelight much more from now."
...
label icarianywaysforsomething:
    ...
    ica "W każdym razie, potrzebowałeś mnie do czegoś?"

    menu:
        "Do you think we should fight alongside the Alliance?":
            jump youshouldalongsidefight
        "Nic więcej. Kontynuuj dobrą prace, Icari.":
            jump morekeepwork
...
label offerhelpnoway:
    ...
    ica "Dzięki kapitanie. Anyways, tell me what ends up happening."
...
label alliancedeclareswar:
    ...
    gre "Kapitanie. Miło cię znowu widzieć."
    kay "Admirał Grey."

    menu:

        "Również miło cię widzieć admirale.":
...
label usbindversta:
    ...
    gre "Nie mam pojęcia, do czego możesz się odnosić."
...
label hadwhichfulfilled:
    ...
    gre "Miałeś misję, którą wypełniłeś. To wszystko, co pamiętam."
    jump worddaringspread

label deathtragicrallying:

    gre "Śmierć dyplomatów była tragiczna, ale nie daremna. Their deaths were a rallying cry for those in Alliance who wanted leadership instead of cowardice."
    jump worddaringspread
...
label worddaringspread:
    ...
    if Saveddiplomats == True:
        ...
        gre "Our fleets are not prepared for this war. Niektóre z naszych statków nie były obsługiwane przez dziesięciolecia. Co gorsza, nasze zapasy i statki są rozproszone po naszym terytorium bez jednoczącego łańcucha dowodzenia."
        gre "Ale nie wszystko stracone, kapitanie. We have very skilled pilots and an economic base which far out produces PACT. We will muster our strength and meet PACT head on. It will merely take time."
    ...
    kay "Jaka jest wielkość floty wroga?"
    ...
    kay "Zrozumiano, admirale."
    gre "Wiem, że proszę o wiele. Aby pomóc ci przygotować się do bitwy, wysyłam ci na statek jednego z moich osobistych doradców."
    gre "Rozumiem, że obecnie szukasz więcej pilotów. Jestem pewien, że będzie ona cennym środkiem dla twojej załogi."

    menu:
        "Będziemy potrzebować wszelkiej możliwej pomocy. Dziękuję, admirale.":
            jump needhelpyou
...
label needhelpyou:
    ...
    gre "Jest utalentowanym pilotem i lojalnym oficerem. I'm sure she'll fit right in with your crew."
    ...
    "... ... ..."
    asa "... ... ..."
    asa "(Pah... Tak dobrze być z powrotem.)"
    asa "(Nigdy nie myślałam, że wyjdę z tego bagna w jednym kawałku...)"
    asa "... ... ..."
    ...
    asa "(Tak wiele się wydarzyło, ale jedyne, o czym mogę myśleć, to kapitan...)"
    asa "C'mon Asaga! Weź się w garść!"
    asa "Jesteś teraz królową!"
    asa "... ... ..."
    ...
    ica "Pospiesz się tam! What's taking forever!?"
    asa "Eek! H-hang on!"
    cla "Oh Icari... Może po prostu wszyscy razem weźmiemy prysznic, skoro jesteś taka niecierpliwa!"
    ica "Z-zamknij się!!! L-like I would ever want to see y-y-your... chest rockets!"
    ...
    asa "Nie! Nie! To nie jest na to czas!"
    asa "You've got a fight to win, Asaga!"
    asa "Come on... Jesteś bohaterem sprawiedliwości! For freedom and equality!"

    show asaga uniform altneutral gloomblush with dissolve

    asa "Uuuuu..... To nie działa..."
...
label guestleashsuspicious:
    ...
    ava "Zrozumiano kapitanie. If she as much as sneezes suspiciously, I'll make a log of it."
...
label asachi_maskofveniczar:
    ...
    asa "Nie, nie, nie, Chigara! You gotta eat before a fight or else you're gonna run outta energy!"
...
label disputeicariphoenix:
    ...
    kay "Co się tutaj dzieje?"

    show kryska uniform altneutral focustalk with dissolve

    kry "Kapitanie Shield. I was informing Ms. Isidolde that her ryder is a potential safety hazard to both herself and the crew."
    ...
    menu:
        ...
        "Przykro mi Icari, ale nie pracujesz już sama. I can't let you risk lives by modifying your ryder.":
            jump solodependrisk
...
label chigarafirsttea:
    ...
    kay "You haven't been looking so well lately. Dalej nie sypiasz zbyt dobrze?"

    show chigara uniform handonchest sad with dissolve

    chi "I'm sorry. I hope I won't be a burden during the battle."
    kay "Nadal jesteś najlepszą inżynier, jaką mamy. Odpocznij."
    ...
    chi "Ah, uhh... I'm sorry, captain. I-I must just sound crazy. Proszę zapomnij o tym właśnie co powiedziałam."
    ...
    chi "Tak..."
    kay "Chcesz o tym porozmawiać?"

    show chigara uniform handonchest forcedsmileblush with dissolve

    chi "Umm... Jeśli to nie jest zbyt wielki kłopot. I was just finishing up with the Liberty here."
...
label techthatdangerous:
    ...
    chi "But captain, technology is only as good as the person wielding it. We właściwych rękach, technologia jak ta może uratować miliony ludzkich żyć."
    chi "To może nawet oznaczać następny etap ludzkiej egzystencji. With such technology, wars, famine, and even human conflict would be mooted."
...
label sohappenedparadox:
    ...
    chi "... ... ..."
    chi "Coś poszło nie tak z projektem. We accidentally opened a black hole in orbit around the planet, destroying our research station and most of Diode in the process. Luckily, I managed to get away on an escape pod... Ale reszta zespołu nie miała tyle szczęścia."
    ...
    menu:
        ...
        "Przykro mi to słyszeć. The accident must have been tragic.":
...
label youexactlywrong:
    ...
    kay "Ale?"
    chi "Pozostaje tylko jedno możliwe wyjaśnienie. What happened on Diode was the work of sabotage. Ktoś z naszego zespołu musiał nas zdradzić."
    kay "Zdradzić? Co ktoś mógłby zyskać, zabijając zespół naukowców?"
    chi "... ... ..."
    chi "Nie wiem. I'm sorry captain. I'm... just rambling again."
    chi "Wiele razy myślałam o tym, co się stało... Nasze wyliczenia... były takie idealne. Nie ma mowy, żebyśmy..."

    menu:
        "Keep searching, Chigara. Black holes don't just pop up and swallow planets for no reason. There's got to be a cause.":
            jump chiteayes
        "Wypadki się zdarzają, Chigara. Po prostu musimy to zaakceptować.":
            jump chiteayes
...
label sorryaccidenttragic:
    ...
    chi "Tak..."
    chi "Nigdy więcej nie chcę patrzeć, jak ludzie wokół mnie umierają. Zrobię co w mojej mocy, aby chronić ten statek."
    kay "Oczywiście, Chigara. We'll do everything in our power to make sure nobody else has to die."
    chi "Tak kapitanie."
    chi "Liczę na ciebie."
    ...
    chi "... ... ..."
    chi "Eh heh..."
    chi "Herbata była pyszna."
    kay "Naprawdę? Moja siostra zdobyła ją dla mnie."
    "... ... ..."
    "... ..."
    "... ... ..."
    chi "Eh heh... Teraz czuję się lepiej."
    chi "I'm glad to have you as our captain."
    kay "Spróbuję cię nie zawieść."
    chi "Thank-you for having me over. You must have other matters to attend to."
    kay "It was my pleasure, Chigara. Możesz pukać do moich drzwi, zawsze kiedy tylko mnie potrzebujesz."
...
label asagachigarasneakingbridge:
    ...
    asa "Shhh Chigara..."
    chi "Ummm... Nie jestem pewna, czy wolno nam tu być, Asaga..."
    asa "This is all for the sake of the ship, Chigara! All for the sake of the ship!"
    kay "Co wasza dwójka tutaj robi?"
    ...
    asa "J-ja? Oh-hohoho! Nie, nie, nie, nie!"
    ...
    kay "You know, everyone can tell that you're here. Widzisz? Look at Ava glaring at you from across the bridge, Asaga."
    ...
    chi "Przepraszam za to, kapitanie..."
...
label planningbattlefarport:
    ...
    kay "Based on our numbers, I don't think this is a battle we can win head on. Jakie są nasze opcje?"
    ...
    ava "Nadal czekam, aż skończysz ze stosem papierów z biurka."
    kay "Oh."
    ...
    ica "Seriously... co wasza dwójka robi?"

    show icari uniform handonhip snide with dissolve

    ica "Heh. Nie wiem co widzisz w tym przegrywie, Chigara. He's just a little schoolboy."
    chi "...Kapitanowie zawsze robią to co jest najlepsze dla załogi."

    show chigara uniform handonchest sadblush with dissolve

    chi "Ale... there's something lonely about him."
    chi "Musi tęsknić za swoim domem."
    ...
    ica "Wait a minute... To nie jest..."

    scene bg captainsoffice with dissolve

    kay "(Nawet w sytuacji jak ta, Ava dalej wciąż zmusza mnie do papierkowej roboty, huh...)"
    kay "(I thought I could get away with it until after the battle...)"
    kay "(Ona zawsze jest zbyt bezkompromisowa! One day, I'm going to have to take her to shore leave and show her how to actually relax...)"

    play music "Music/Proditionis.ogg"

    "Icari over Radio" "Kapitanie, potrzebujemy cię w hangarze!"
    kay "Icari? Co się stało?"
    ica "That Alliance mole's been tampering with our systems! You've gotta arrest her!"
    kay "Zaraz będę na dole."
    ...
    ica "Widzisz? Ona jest szpiegiem!"
    kay "Jesteś pewna, Chigara?"

    show chigara uniform handonchest sad with dissolve

    chi "Tak... I have it all on video... Since I did set up some cameras in engineering and all..."

    menu:
        "Spójrzcie ludzie, jesteśmy teraz wszyscy po tej samej stronie.":
            jump peoplesamehere
...
label peoplesamehere:
    ...
    ica "Ale kapitanie! She's Alliance Black Ops! Z tego co wiemy, może poderżnąć nam gardła podczas snu! Those people aren't accountable to anyone!"

    show kryska uniform neutral angry with dissolve

    kry "For the record, the Alliance does not have a Black Ops."
    ica "Nie wkurwiaj mnie! What kind of self respecting military does NOT have a Black Ops!?"
    kay "Uspokój się Icari. Weren't you the one who was always saying we needed the Alliance on our side if we're going to win this war?"
...
label battlefarportstart:
    ...
    ava "The PACT invasion fleet's just warped in. Dystans: 10 000 kilometrów, zbliżają się szybko."
    kay "Rozmiar?"
    ava "Większa niż cokolwiek co dotychczas widzieliśmy. Roughly 20 battleships and carriers. Ponad 600 statków w całości."
    ...
    asa "All ready down here, captain! Daj słowo!"
    ...
    kay "Będziemy musieli poradzić sobie z tym później. For now, I need all the ryders we have."
    ...
    cul "Głupcze! We will crush the Alliance just as we crushed the Neutral Rim! The future belongs to PACT!"
    ...
    ava "Kapitanie?"
    kay "Cullen's only fought weakly defended Neutral Rim worlds and the remnants of the New Empire during the PACT Revolution. Jest zbyt pewny siebie i nie docenia nas."

    show ava uniform handonhip mad with dissolve

    ava "Jakie są twoje rozkazy?"
    ...
    ava "Odważny plan, kapitanie. Ale co z Legionem?"
    kay "Miejmy nadzieję, że jest tu tylko tutaj poogelądać imprezę. Nie zaangażują Legiona w bitwę, jeśli na pokładzie znajduje się Arkadius. Jest zbyt ważny, aby ryzykować podjęcie walki."
    ava "Zatem miejmy nadzieję, że on tam patrzy."

    play music "Music/DayDream_Cut.ogg" fadeout 1.5

    kay "Połącz mnie ze wszystkimi naszymi statkami."
    ...
    kay "Wszystkie statki, mówi Kapitan Shield."
    ...
    chi "(Kapitanie... Daj z siebie wszystko!)"
    ...
    arc "Powiedzcie, moi towarzysze, czy pozwolimy tym kapitalistom żyć?"
    ...
    asa "(Ja... zamierzam wyszstkich chronić...!)"
    ...
    kay "W obronie innych światów, będziemy przeć naprzód! Let the crimson fleet learn today the might of the free men of the Alliance!"
    kay "Wszystkie jednostki... NAPRZÓD!!"
...
label mission12:
    ...
    if check3 == False:
        ...
        "Podpowiedź 1: Use the Short Range Warp order to instantly relocate the Sunrider to another location."
        "Podpowiedź 2: PACT Carriers will continually launch enemy ryders until destroyed."
    ...
    if check2 == False and BM.turn_count == 6:
        ...
        ava "Wrogie krążowniki są już w zasięgu broni!"
...
label after_mission12:
    ...
    arc "Głupcze. We long suspected his incompetence."
    fon "Shall we assist?"
    arc "Tak Fontana. Prepare to fire the Legion's main cannon."
    fon "But sir... At this distance, there is a risk that we would hit our own ships as well."
    arc "That is irrelevant. Zniszczyć ich wszystkich."
    fon "Understood, my Veniczar."

    scene bg bridgered with dissolve
    show ava uniform altneutral angry with dissolve

    ava "Uwaga! The cruiser fleets have reached weapons range! We're taking heavy fire!"
    kay "Jaki jest status floty dowodzenia wroga?"
    ava "Zestrzeliliśmy większość okrętów dowodzenia, ale flagowiec Cullena nadal pozostaje cały!"

    show ava uniform neutral surpriseangry with dissolve

    ava "Cz-czekaj... Wykryto skok energii! To Legion!"
    kay "Rozkaż flocie wykonanie manewrów unikowych!"
    ...
    cul "Prepare to fire the quantum torpedo! Celujcie w  Sunridera!"
    ...
    ava "Potwierdzono trafienie! The enemy fleet's flagship has been sunk!"
    kay "Tak!"
    ...
    ava "U-ugh!"
    ava "Atak wroga trwa nadal! Nasza flota upadła do 33 procent!"
    ava "Nie będziemy w stanie przetrwać dużo więcej!"
    kay "Rozkaż flocie się rozproszyć! Osiągneliśmy nasze cele!"
    ...
    gre "Wszystkie jednostki! Otworzyć ogień!"
    ...
    arc "Nie."
    arc "Bitwa już nam nie sprzyja. Rozkaż naszym siłom wycofać się."
    ...
    arc "... ... ..."
    arc "Ta strata jest nieistotna."

    show arcadius fist with dissolve

    arc "Wkrótce... the galaxy will witness the true power of what we accomplished at Diode... And tremble!"
    ...
    ava "To była tylko pierwsza bitwa wojny. Jest jeszcze za wcześnie, aby świętować."
    ...
    ica "Well, I guess you're not that bad of a shot! Po prostu mów mi Icari, w porządku? Nie lubię rang ani tytułów przed moim imieniem."
    kry "Oczywiście."
    ...
    kay "Odnośnie tego..."
    kay "Oto dane, do których próbujesz uzyskać dostęp."
    kay "Jeśli mamy zamiar być zespołem, będziemy musieli nauczyć się sobie ufać. Następnym razem, gdy będziesz potrzebować informacji, dlaczego po prostu nie zapytasz?"
    ...
    kry "Understood sir. Będę cię informować osobiście, jeśli moi przełożeni będą chcieli uzyskać informacje w przyszłości."
    ...
    ica "Z-zamknij się! This is only so we can beat PACT!"
    ...
    ava "Kapitanie?"
    kay "Trudno uwierzyć, że był to tylko pusty hangar, kiedy po raz pierwszy opuściliśmy Cerę."
    ava "Powiedziałeś, że zbierzesz sojuszników z całej galaktyki."
    kay "Yeah. I did."

    show  ava uniform handonhip forcednarrowsmile with dissolve

    ava "Dobra robota, kapitanie. Dobra robota."
    ava "... ... ..."
...
label beachepisode(reset_lowest_difficulty = False):
    ...
    cla "O mój... Jesteś przerażona moimi... rakietami?"
    ...
    ica "T-tsch... Co powiedziałaś!?"

    show icari beach armscrossed mock with dissolve

    ica "Oh I'm sorry! Ale nie chciałabym zrobić się tą wielką, by omyłkowo być braną za kosmicznego wieloryba!"
    ...
    ica "Haha! Zbyt wolno! Jak zawsze!"
    ...
    cla "Oh moja Chigaro... You've still got so much catch up to do until you can compete with me."
    chi "Uuu... K-kapitan nie interesuje się t-tymi rzeczami... K-kapitan nie interesuje się tymi rzeczami... Kapitan nie interesuje się tymi rzeczami..."
    ava "H-hurk..."
    ...
    ava "Kapitanie, muszę sprzeciwić się decyzji o udzieleniu załodze przedłużonego urlopu na lądzie w tych trudnych czasach!"
    kay "Ava..."
    ...
    kay "Ava..."
    kay "Spośród wszystkich ludzi na pokładzie, ty najbardziej potrzebujesz przerwy."
    kay "Kiedy po raz ostatni robiłaś coś zabawnego?"
    ...
    ava "Ale dokumenty-"
    kay "Mogą zaczekać."
    kay "Kup sobie strój kąpielowy. Get some drinks. Popełniaj błędy."
    kay "To jest rozkaz."
    ...
    kry "Z ponad 100 akrami plaż i lasów, to jest idealne miejsce na wakacje!"
    ...
    ava "While it is my desire to run a tight ship... czasami wyjątki muszą być uczynione dla dobra załogi."
...
label beachasaga:
    ...
    asa "Our ryders were obsolete. Nie mieliśmy flot kosmicznych."

    show asaga beach excited happy with dissolve

    asa "Anyways, that's enough boring stuff! Jesteśmy na plaży! Let's have fun!"
    ...
    sol "Ludzie szukają uczuć w czasach zagrożenia."
    ...
    asa "Właśnie taka odpowiedź, jakiej się spodziewałam! You never disappoint, capt'n!"
    asa "Uwah-hahahahaha!"
    ...
    if beachtalk > 0:
        ...
        kay "(Teraz, z kim powinienem porozmawiać?)"
...
label beachchigara:
    ...
    chi "Tak. Working with my hands always was my thing."
    ...
    chi "Kaappiittaannie!!! Proszę zapomnij o tym co właśnie powiedziałam!!!"
    ...
    kay "Nie martw się, Chigara. Wiem."
...
label beachclaude:
    ...
    kay "(Żegnaj... It was nice knowing you!)"
...
label afterbeachtalk:
    ...
    ava "Kapitanie. Please do not get overly sentimental."
    ...
    kay "Pamietasz ją? How she'd always start spinning her hair in her fingers whenever she was nervous?"

    show ava beach facepalm with dissolve

    ava "Nie. Only you would remember a detail like that, captain."
    ...
    ica "It's not a big deal. Po prostu mu powiedz co czujesz, Chigara."

    show chigara beach twiddlefingers sadblush with dissolve

    chi "A-and then? C-co jeśli on mnie nie lubi?"
    ica "Pfft. It's not like it's the end of the world. Then you just move on."
    chi "A-ale... Nie jestem pewna czy bym mogła..."
    ...
    ica "I kto wie. Tomorrow, one stray quantum torpedo could end it all. And the captain would never have known that there was a girl named Chigara who liked him. Are you gonna let that happen?"
    ...
    asa "U-uhh..."
    asa "Yeah, Chigara! Możesz to zrobić!"
    asa "Remember how you're always repairing me whenever I get busted up in battle? Uratowałeś moją skórę więcej razy, niż potrafię zliczyć." #fixed my hide here
    asa "Uh, basically, what I'm sayin' is that you're my friend! Najlepszą jaką kiedykolwiek miałam!"

    show asaga beach excited forcedhappy with dissolve

    asa "Możesz to zrobić, Chigara! I believe in ya!"
    ...
    cla "Wiesz... I've already touched his thing..."
    ...
    chi "U-uu..."
    chi "... ... ..."
    chi "O-okay... Zamierzam to zrobić."
    ...
    ica "W porządku! We'll just have to lure the commander away from him."
    ...
    "Shield wziął kawałek mięsa z grila i położył go na tależu Chigary."
    ...
    ica "Yo capt'n!"
    ica "Heh, wcale nie jesteś taki zły."
    ...
    kry "Przepraszam kapitanie. Wygląda na to, że nasz najemnik jest troszkę pijany."
    ...
    kay "W porządku, w porządku. Wystarczy, panie."
    "Shield napełnił talerz Icari mięsem."
    kay "There you go."
    ...
    "Shields wręczył talerz z jedzeniem Soli."
    kay "Musisz być głodna."
    "Sola złapała za widelec i wzięła gryz gotowanej cebuli."
    sol "... ... ..."
    ...
    sol "Nie zawsze byłam księżniczką. For most of my life, I was merely a lowly peasant, hardly worth more than the livestock we raised."
    ...
    menu:
        ...
        "To musiało być trudne dla twojej mamy.":
...
label deathhisheir:
    ...
    sol "Tak. So she used her connections to find me."
    ...
    sol "... ... ..."
    sol "It is strange."
    sol "Po raz pierwszy w moim życiu, byłam..."
    sol "... ... ..."
    sol "...szczęśliwa."
    ...
    sol "... ... ..."
    "Shield położył rękę na jej ramieniu."

    menu:
        "Obiecuję, że już nigdy więcej nie będziesz musiała poświęcać swojego życia. Nie, dopóki ja jestem kapitanem.":
...
label heardexplosioncolor:
    ...
    asa "Come over here, capt'n! Mamy więcej jedzenia!"
    ...
    sol "You have my appreciation. Nie jako księżniczki, lecz zwykłej dziewczyny."
    kay "My pleasure."
    ...
    chi "A-ah... Tutaj jesteś, kapitanie."
    ...
    kay "C-Chigara? Wszystko w porządku?"
    chi "Mmm."
    ...
    asa "(Uwaahhh!!! Nie dobrze, nie dobrze!)"
    cla "Ooooaaahhh!!!"
    kry "Gaassp..."
    ...
    chi "Wszyscy się martwimy o Ciebie."
    chi "Ja zawsze martwię się o Ciebie."
    ...
    chi "Kapitanie..."
    chi "Dlaczego zawsze chcesz być sam?"
    ...
    chi "Zawsze taki jesteś. Dla każdego."
    chi "I know how it must feel. To dlatego chcę ci pomóc."
    chi "Whenever I think of what it must be like, leading us to battle all the time, I just want to..."
    chi "... ... ..."
    kay "Nie musisz nic mówić."
    kay "Wiem."
    chi "... ... ..."
    ...
    chi "... ... ..."
    chi "Już późno. Powinnam iść."  #fixed    should be getting going
    kay "Dobrej nocy. Sleep tight."
    chi "I will. Dobrej nocy, kapitanie."
    ...
    ica "Oh well. Myślę, że na nas też czas by iść do łóżek."
    cla "Aww..."
    ...
    ava "(N-niewiarygodne... To think that I would make such a mockery of myself...)"
    ...
    kay "Dobrze."
    kay "Wiedziałem, że mogę ci zaufać, Ava."
    kay "A teraz ruszajmy."
    kay "Mamy wojnę do wygrania."
...
label cosettearcpart1:
    ...
    ava "Dzień dobry, kapitanie. The ship is yours to command."
    kay "What's our status?"
    ava "We are fully stocked and ready to go on your command."
    kay "W porządku. Let's stretch our legs a bit."
...
label checkformissions:
    ...
    kay "W porządku. Any other missions?"
    ...
    kay "W porządku. So let's get to it then."
    ...
    kay "Więcej piratów? Seems like there's never going to be an end to them."
...
label clearoutpirates:
    ...
    kay "Czerwony alarm! All hands, prepare for combat!"
...
label after_mission13:
    ...
    ava "Wszyscy piraci zostali zneutralizowani."
...
label investigatemoon:
    ...
    ava "Uwaga! I'm detecting new energy signatures!"
    kay "PACT?"
    ava "Nie... Ryuvian!"
    ...
    kay "Czerwony alarm. Więcej statków widmo?"
    ava "I've got a bad feeling about this, captain. Perhaps we should retreat."

    menu:
        "Te statki coś chronią... Coś bardzo cennego. We're going to find out what.":
...
label standvaporizedwarp:
    ...
    ava "Zrozumiano kapitanie. Hitting thrusters!"
    ...
    ava "Zrozumiano kapitanie. Przygotuję raport po mojej zmianie na mostku."
...
label mission14:
    ...
    if check1 == False and BM.turn_count == 2:
        ...
        ava "Kaptanie, nowa jednostka właśnie dołączyła do bitwy!"
        ava "To jest... unlike anything I've ever seen before!"
        "Podpowiedź: The Retreat Order is available to escape from this battle."
...
label after_mission14:
    ...
    ava "Misja zakończona powodzeniem, kapitanie. All hostiles have been neutralized."
    ...
    kay "Interesujące. Jakieś pomysły co to może być?"
...
label retreat:
    ...
    ava "Warp successful, captain. Pomyślnie uciekliśmy przed wrogiem."
    kay "(Będziemy potrzebować lepszych broni przed ponowną próbą!)"
...
label mission15:
    ...
    if check3 == False and BM.turn_count == 3:
        ...
        ava "Wrogie okręty bitewne są już operacyjne!"
...
label after_mission15:
    ...
    ava "Misja zakończona sukcesem, kapitanie! All PACT units have been eliminated!"
...
label officeelectiongrey:
    ...
    ava "Kapitanie. I've got the Alliance acquisition manifest for your approval."
    ...
    ava "Sigh... Masz rację. I'm getting too soft. Removed."
...
label bestwinsthiswar:
    ...
    kay "This war will not be won without sacrifice. Od wszystkich z nas."
...
label medicallicensereinstated:
    ...
    cla "Kapitanie! I'm shocked at the suggestion!"
    ...
    kay "W porządku... I guess we could still use a doctor."
...
label lieutenantanothervisitor:
    ...
    kay "W porządku. I'll just ring him up on the FTL comm."
...
label greyonboard:
    ...
    gre "Kapitan Shield. Miło w końcu spotkać się osobiście."
    ...
    gre "Wojna jest daleka od wygranej, ale fala jest na naszą korzyść."
    gre "Still, we mustn't become overconfident. Sytuacja jest dalej... Niepewna. The Veniczar has held back his greatest fleets from a direct confrontation so far. Niewątpliwie czeka, aż staniemy się aroganccy i popełnimy nieostrożne błędy."
    kay "Porozmawiamy więcej w moim biurze. Ale najpierw, przygotowaliśmy wycieczkę po statku."
    gre "Ah, oprowadź mnie, kapitanie. I hear your ship is one of the finest in the Neutral Rim."
    ...
    arc "Przyprowadź do nas księżniczkę. Ale resztę zabij."
    arc "It has just arrived at Ongess. Take your best ships and draw it out."
    arc "Captain Shields is young, but still a formidable enemy. Nie lekceważ go, bo spotka cię taki sam los, jaki spotkał Cullena."
    fon "Understood, my leader!"
    ...
    kry "Admirale! Jesteś ranny?"
    gre "I'm fine!"
    kay "Co to do diabła było!?"
    "Ava on Comm" "Kapitanie, potrzebujemy cię na mostku!"
...
label chigarateatimedoubts:
    ...
    "Chigara on Comm" "Umm... Kapitanie, to ja."
    kay "Wejdź, Chigara."
    ...
    chi "Kapitanie... Please stop calling me that. It doesn't suit me."
    kay "Hah, sorry."
    ...
    kay "W porządku, ja również lepiej wrócę do pracy."
    ...
    chi "Umm..."
    chi "If it's alright... May I keep coming here? Ja... enjoy our tea time together."
    kay "Oczywiście, Chigara."
...
label lookinstarsasaga:
    ...
    kay "... ... ..."
    kay "We all try to be like that. Ale to nie jest zbyt łatwe w prawdziwym życiu."

    show asaga uniform handsonhips closedeyesgrin with dissolve

    asa "Nigdy nie powiedziałam, że jest, kapitanie."
    asa "Ale, czyż nie wszystkie wartościowe rzeczy w naszym życiu, są trudne do uzyskania?"
    kay "Heh. I guess that's true."
    kay "Dzięki za to, Asaga."
...
label wordfastsay:
    ...
    kay "W porządku. Let me contact Ava on the comm. I'll tell her that I'll be leaving for a few hours to inspect the Alliance's occupation first hand."
    ...
    kay "Come here, little girl. Jak masz na imię?"
    ...
    kyo "Kyoko."
    kay "Jestem Kayto. A to jest Kryska."
    kyo "Kayto, Kyoko, i Kryska?"
    kay "Hahaha. We make quite the trio."

    show kyoko neutral sad with dissolve

    kyo "Moja mamusia mówi, że nie powinnam rozmawiać z obcymi."
    kay "Twoja mamusia ma rację. Ale nie martw się, nie jesteśmy tu by cię skrzywdzić."
    ...
    kyo "Proszę zabierzcie mnie z tego miejsca! Nie chcę tu być!"
    ...
    kay "Nie. Widziałem już wystarczająco."
...
label apprechiatevalueindependence:
    ...
    kay "Kryska... Są rzeczy warte więcej niż pieniądze."
...
label suddenlymaskedalleyway:
    ...
    kyo "That's him right there! On jest kapitanem!"
    kay "(Damn! I got careless!)"

    show cosette plugsuit altneutral angrylaugh with dissolve

    cos "Dobra robota, mój mały ptaszku. You've earned this platinum."
    ...
    kay "Popełniasz błąd, Cosette. You should never have brought children into this!"
    ...
    kry "Kapitanie! Are you all right?"
    kay "U-ugh... Yeah."
    ...
    "Strażnik" "Szef chce z tobą rozmawiać!"
    kay "Okay. We won't cause trouble."
    "Kryska stood as well."
    "Strażnik" "Nie ty! Tylko on!"
    kay "Do as he says, lieutenant."
    kay "Nie martw się. I think Cosette intends to keep us alive. Use us as leverage."
    ...
    cos "Kaapiitaaan. Moja najulubieńsza postać na świecie."
    cos "Usiądź."
    ...
    cos "Dzieci rodzą się z jednym okiem. Sześcioma palcami."
    ...
    kay "... ... ..."
    kay "Nie jestem jednym z nich."
    kay "Pochodzę z neutralnego świata, takiego jak twój."
    kay "Posłuchaj mnie. I have the Admiral's ear. Just give me your demands, and we can make amends."
    ...
    cos "... ... ..."
    cos "Za późno na to, kapitanie."
    cos "Independence, or death."
    cos "All Alliance ships out of Ongess within 48 hours. To moje jedyne żądanie."
    kay "... ... ..."
    ...
    "Cosette wyszeptała do ucha Shieldowi."
    ...
    cos "Ona również była biznesmenem."

    show cosette plugsuit point yanderegrin with dissolve

    cos "Don't presume you know everything, captain! You know nothing!"
    kay "Cosette...!"
    cos "I killed her like the bitch she was! I zabiję każdego innego, kto wejdzie mi w drogę!"
    cos "Jestem Cosette Cosmos! Terror of the stars!"
    cos "Nobody fucks with me! NIKT!"
    kay "Popełniasz błąd!"
    ...
    kry "Jesteś ranny, kapitanie. I'm not going to let you stay here."

    show kryska uniform altneutral sad with dissolve

    kry "To był mój błąd. Jestem tą, która cię tu zabrała."
    "Steel screeched as the guard undid the gate."
    "Strażnik" "Hej ty. Szef chce cię widzieć."
    kay "W porzadku."
    "Guard" "Nie! Tym razem dziewczynę!"
    "Shields looked at Kryska with apprehension."

    show kryska uniform altneutral focustalk with dissolve

    kry "Nie martw się kapitanie. I can take care of myself."
    ...
    kyo "...!!!"
    "Dziewczynka podniosła upuszczony przez Cosette nóż."
    kay "Nie! Put the knife-"
    ...
    gre "Kapitanie. You have my sincerest apologies for our security lapse."
    gre "To była nasza odpowiedzialność chronić ciebie podczas twojej inspekcji. I zawiedliśmy."
    "Shield zamknął swoje oczy."
    kay "Tell me this, Admiral. Ile cywili zginęło podczas gdy mnie ratowaliście?"
    ...
    gre "... ... ..."
    gre "Kapitanie. Let me be frank with you."
    ...
    menu:
        "Nie. I'm going with this to the press. Prawda musi zostać powiedziana.":
...
label goingpresstruth:
    ...
    kay "... ... ..."
    kay "Widziałem..."
    kay "Ona była na tyle młoda, by być jedną z twoich wnuczek, Admirale!"
...
label toostakehandle:
    ...
    kay "Oczywiście, Admirale. I... will think of them as well. As I fight to stop PACT."
    gre "To wszystko, kapitanie."
...
label liaisonofferapologies:
    ...
    kry "To była moja odpowiedzialność, by chronić cię podczas inspekcji. And in that regard, I have failed."
    kry "I will accept whatever punishment you deem fit."
    kay "At ease, lieutenant."
    kay "Nie. Inspekcja pozwoliła mi dostrzec wiele rzeczy."
...
label alliancecannotbetrusted:
    ...
    kry "... ... ..."
    kry "Nie rozumiem, kapitanie. Now Cera is under PACT occupation, and without our help, Ongess will become another dark world."
    kay "... ... ..."
...
label reportwhattranspiredongess:
    ...
    kay "(Czy podjąłem właściwą decyzję?)"
    ...
    cos "Tsch, the damned bastard got away. Powinniśmy go po prostu zastrzelić, kiedy mieliśmy okazję."
    "Pirat" "Sir, we're getting an FTL transmission."

    show cosette:
        zoom 1.0
        ease 0.5 xpos 0.7

    cos "Wiadomość? Put it through."
...
label asagagladseeup:
    ...
    kay "Nie martw się. Nie pozwoliłbym się zabić przez ulubieńców Cosmos."

    show asaga uniform excited angry with dissolve

    asa "Czy gdziekolwiek cię skrzywdziła !? The next time I tangle with her, I'm gonna give her a piece of mah mind!"
    kay "Tylko uderzenie w głowę. Nic poważnego."
    asa "T-to... szumowina!! I'll be sure to get you some payback, capt'n!"

    menu:
        "We'll take down Cosette together.":
            jump wellcosettedown

        "Cosette po prostu walczy by chronić swoich własnych ludzi. Nie jest taka zła jak myślisz, Asaga.":
...
label wellcosettedown:
    ...
    asa "You betcha! Next time I see her, I'll put her down for good! Zobaczysz!"
...
label cosettefightingbad:
    ...
    asa "Nie, nie, nie, nie!"
    asa "Don't listen to her propaganda, capt'n! Jest tylko złym piratem, to wszystko!"
    asa "Uderzymy nią o ziemię za wszystkich, których skrzywdziła! Włączając Ciebie!"
    kay "Heh-heh... W porządku, Asaga..."

    jump asagasmileleave

label asagasmileleave:

    kay "Dzięki za troskę. But don't worry, I'm all right now."
    "Shield wysłał Asadze uśmiech i odwrócił się do wyjścia."
    "She grabbed the tail of his coat."

    show asaga uniform altneutral sadblush with dissolve

    asa "... ... ..."
    asa "Nie rób nam tego ponownie. Wszyscy się martwiliśmy."
    kay "... ... ..."
    kay "Byłem nieostrożny. To się nie powtórzy."
    ...
    asa "And I'll bet my money that Cosette's gonna show her mug again. I tym razem będę gotowa!"
    kay "(Ta Asaga... Ona nigdy się nie zmienia...)"
    kay "Trzymaj się, Asaga..."
...
label ryuvianongesssharr:
    ...
    sol "Kapitanie."
    kay "Czy gwiazdy odpowiadają na wszystkie twoje pytania?"
    sol "... ... ..."
    sol "Chcesz porozmawiać?"
    ...
    sol "Ja? Nie zastanawiałam się nad takimi sprawami."
    ...
    sol "... ... ..."
    sol "Cokolwiek się zdarzy, jestem pewna, że podejmiesz decyzję bazującą na tym, co dobre dla galaktyki."
    kay "Zastanawiam się co to jest. Pojęcie \"dobra galaktyki\" jest trudne do zdefiniowania. To może znaczyć wszystko."

    show sola uniform backturn neutral with dissolve

    sol "... ... ..."
    sol "Jestem tylko prostą dziewczyną, kapitanie. Proszę, nie oczekuj ode mnie zbyt wiele."
    kay "Hahahaha."
    kay "Dzięki, Sola. Wrócę do ciebie, jeśli będę potrzebować porady."
    sol "Mm."
...
label messhallasagacalibrating:
    ...
    chi "Ah, kapitan."
    kay "Huh, jesteś dzisiaj sama."

    show chigara uniform handstogether sad with dissolve

    chi "Ah, tak... Asaga's been acting strange lately."
    chi "Częściej kalibruje Black Jacka. Przestała nawet grać w swoje gry i teraz całe dnie ćwiczy w symulatorze."
    kay "Uh, naprawdę? To niezwykłe."
    ...
    chi "Wszyscy wiedzą, że nadchodzi kolejna bitwa. Wszyscy robimy co w naszej mocy."
    kay "... ... ..."
    kay "Czuję, że ta będzie inna. PACT's been acting strange."

    show chigara uniform neutral neutral with dissolve

    chi "W jaki sposób?"
    kay "Wrócili z mniejszą siłą po wycofaniu się. A force that size wouldn't be able to conquer Ongess by itself."
    kay "I'm not sure what they're after this time."
    chi "Czy uważasz, że piraci Cosette mają z tym coś wspólnego?"
    kay "Bez wątpienia."
    ...
    kay "Nie dołączasz do nas?"
    asa "Oh, nie, nie, nie, nie, nie! I've got more scenarios to run on the simulator!"
    asa "Can't let the skills get dull, ya know! Who knows when PACT might attack again!"

    menu:
        "Upewnij się, że nie przesadzasz, Asaga.":
            jump sureexertasaga

        "Wow, jestem pod wrażeniem. What's come over you?":
...
label seeenjoyworry:
    ...
    chi "Czasami, martwię się o nią..."
    kay "Nie martw się, Chigara. Porozmawiam z nią później i dowiem się, co się dzieje."
    chi "Dziękuję, kapitanie."
...
label icaribelievelet:
    ...
    kry "To była chaotyczna sytuacja! Nie możesz oczekiwać, że zapamiętam każdy szczegół!"
    ...
    ica "J-J-J  nie m-mam pojęcia o czym ty mówisz! H-hahaha!!"
    ...
    cla "Robisz się czerwona..."
    ica "Wychodzę! T-the Phoenix needs... calibrations!"
    ...
    kay "Zawsze stara się zachowywać fajnie, a później..."

    show icari uniform point shoutblush:
        zoom 1.0 xpos -0.2
        ease 0.3 xpos 0.1 rotate 15

    ica "NIE ZAWSZE STARAM ZACHOWYWAĆ SIĘ FAJNIE!"
...
label captainsituationpiratepact:
    ...
    kay "Czerwony alarm. Power our weapons and prepare to launch our ryders."
    ...
    kay "Should have figured Cosette would show her face sooner or later. Rozmiar?"
    ava "Największa flotaa piracka, jaką kiedykolwiek widzieliśmy. We never thought they could organize something that large. They must have pulled in ships from over fifteen different crime rings."
    ...
    fon "Kapitan Shield. A pleasure to finally meet you. I am Veniczar B. Fontana of the Crimson Fleet. I am here to retrieve the princess and end your occupation of Ongess."
    ...
    kay "Nie tak szybko, Fontana. We already took care of your friend. Uhh... jak mu było na imię..."
    kay "Taki wielki facet z wąsem! And you're coming at us with less than half the ships he did."
    ...
    ava "Flota piracka zbliża się od dołu."
    ...
    kay "To moment, na który wszyscy czekaliśmy. Remember your training, and make us proud!"
...
label after_mission16:
    ...
    ava "Misja zakończona, kapitanie. Siły wroga zostały zdziesiątkowane."
    ...
    kay "Widzisz, Fontana? Now why don't you stick your tail between your legs and scurry back to New Eden?"
    ...
    kay "Fontana...!"
    fon "To dla ciebie koniec, kapitanie!"
    ava "To pułapka! The initial PACT fleet was merely a decoy, captain!"
...
label after_mission17:
    ...
    cos "Heh-heh-heh... Zapomniałeś już o mnie, kapitanie?"

    show ava uniform neutral angrytalk with dissolve

    ava "Uwaga! New pirate signatures!"
    kay "Co!? Gdzie!?"
    ...
    ava "Catastrophic losses are being reported! Twoje rozkazy, kaptanie!?"
    ...
    gre "Raz..."
    cos "NIE SŁUCHAJCIE GO!! He's too much of a coward to fire!!"
    fon "... ... ..."
...
label unitsbreakpointtoday:
    ...
    cos "Wszystkie jednostki! Break off and warp away to the fall back point! We've done enough for today!"

    hide cosette with dissolve
    hide fontana with dissolve
    show ava uniform altneutral angry with dissolve

    ava "The enemy fleets are falling back! Plan zadziałał!"
    ...
    gre "Wierzę, że Cera jest nie tak daleko stąd, czyż nie?"
    kay "Nie."
...
label incidentongesshit:
    ...
    ava "Czy czujesz się w porządku, kapitanie?"
    kay "Przypuszczasz, że Cosette ma rację?"

    show ava uniform alt neutral mad with dissolve

    ava "Kapitanie. Cosette jest wariatką i przestępczynią."
    ...
    ava "... ... ..."
    ava "To jest wojna. It's either them or us."
    kay "... ... ..."
...
label newssecondongessthe:
    ...
    kay "... ... ..."
    kay "Jestem kapitanem. My duty is to my crew."
    ava "... ... ..."
    kay "Gdy tylko wojna się skończy umyjemy ręce i wrócimy do naszego cywilnego życia. But until then, we will show no quarter."
...
label crewdownmean:
    ...
    chi "Co masz na myśli, kapitanie?"
    ...
    kay "Fontana... He's a good man. I Grey również nie jest mordercą."
    kay "And yet... When the lives of those around us are in danger... Musimy podejmować decyzje, których normalnie nigdy byśmy nie podjęli."
    kay "Decyzje o zamordowaniu miliardów ludzi. Decyzje o ignorowaniu okrucieństw. Decyzje o skazaniu niewinnych na śmierć."
    chi "... ... ..."
    chi "That's what separates leaders from followers, captain."
    chi "Cokolwiek zadecydujesz, wiem, że będzie dla większego dobra."
    kay "... ... ..."
    chi "Zawsze będziesz moim bohaterem, kapitanie."
    kay "... ... ..."
    ...
    kay "... ... ..."
    chi "Nie ważne co się stanie, zawsze będę tu dla ciebie."
    kay "Dzięki Chigara..."
...
label goodmorningsituation:
    ...
    kay "Dzień dobry. Give me the situation."
    ...
    ava "To wszystko, kapitanie."
    kay "Dzięki za raport. Trzymaj się, Ava."
...
label jumptotydariaescort:
    ...
    kay "All right, let's get this done. Rozpocząć operację!"
...
label mission18:
    ...
    if check2 == False and BM.turn_count == 2:
        ...
        ava "Kapitanie... Please remain focused on the mission..."
    ...
    if check5 == False and BM.turn_count == 7:
        ...
        ava "Kapitanie... Shouldn't we be done with this mission by now?"
        kay "Hang on... I can get a couple more units..."
        ava "Please take this more seriously! To nie jest gra!"
...
label thatsthatIguess:
    ...
    sop "As usual, the Union appreciates your assistance. Do widzenia, kapitanie."
...
label shieldsputpicture:
    ...
    "Ava on Comm" "Kapitanie, jesteś potrzebny na mostku."
...
label prioritymessagelegion:
    ...
    fon "Wybacz mi. Nie zawiodę ponownie."
    ...
    ava "... ... ..."
    ava "I wonder..."
    ava "Miłość to tylko reakcja chemiczna."
    ...
    ava "Twoje oczy przesyłają do mózgu elektroniczne informacje o tym, co widzisz."
    ava "Ale skąd wiesz, czy którakolwiej jest prawdą?"
    ava "Nasza rzeczywistość to tylko symulacja tego, co naprawdę istnieje."
    ...
    kay "To dlatego, że wszyscy jesteśmy wolnymi ludźmi."
    ava "... ... ..."
    kay "Zawsze musisza komplikować tak proste rzeczy."
    ava "Oh?"
    ...
    kay "Co!? Why you listen here-!"
    ava "... ... ..."
    "Ava obrzuciła Kayto lodowatym spojrzeniem."
    kay "(To dlatego właśnie nie masz żadnych przyjaciół!)"
    ava "... ... ..."
    ava "Dummy."
    ...
    ava "Kapitanie."
    kay "Rozpocząć operację. Będę w moim biurze."
    ava "Zrozumiano."
...
label asagafancyworry:
    ...
    asa "Nie martw się! We'll smash up that Legion just like we smashed up Porkchops back at Far Port!"
...
label solasickbaywhisper:
    ...
    sol "Weird?"
    kay "Wiesz... Like poke you in embarrassing places... Or touch you for no apparent reason..."
    ...
    cla "I became a shamed woman that day! Nigdy tego nie zapomnę!"
...
label uhyoureyears:
    ...
    cla "K-kapitanie! You hurt Sola's feelings!"
    kay "Przepraszam, tylko się upewniłem!"
...
label remembertimeforeign:
    ...
    sol "Pamiętam moją linię czasu tak wyraźnie jak dzień. Further, this world is as foreign to me as my time would be to you."
    ...
    kay "W porządku. Powiedz mi co znajdziesz. Ja również jestem ciekawy."
    sol "I will, captain."
...
label icarimessviewstorm:
    ...
    ica "Look, you pretend to be all smiles with the crew. Ale wszyscy widzimy te ciemne chmury zbierające się nad twoją głową."
    ica "Szczerze mówiąc, zaczyna mnie to również niepokoić"
    kay "... ... ..."
    kay "Nie pozwolę, aby wpłynęło to na moje osądy."
    ica "Wiesz, kiedy mi się to przydarzyło, miałam zaledwie dwanaście lat."
...
label shieldseyefile:
    ...
    kay "Her dad's usually starside. Jest dość ważną osobą, więc rzadko jest w domu."
    mar "Eehh..."
    ...
    mar "Ah. Wiedziałam. You have a holo of her set as your background."
    kay "T-to tylko zdjęcie z naszej podróży treningowej!"
    mar "Eeehhh... Więc nawet poszedłeś z nią na plażę..."
    kay "Byłem z czterema innymi osobami!"
    ...
    ava "Zrozumiano, kapitanie. We will ready the plans."
    kay "Dismissed."
    ...
    fon "Zrozumiano! I will depart at once!"
    ...
    kay "Kto wie. Może któregoś dnia będziesz mogła zobaczyć to osobiście."
    ava "... ... ..."
...
label bogiespiratefind:
    ...
    ava "Zrozumiano, kapitanie. Going dark."
    kay "Now we wait..."
    ...
    kay "Hold steady."
    ava "Dystans do wroga: 60 000 kilometrów."
    ava "They are slowing to intercept."
    kay "Hold."
    ava "Dystans: 50 000 kilometrów."
    ...
    ava "The enemy has just adjusted their course to compensate. They are still on an intercept vector. Dystans: 40 000 kilometrów."
    kay "Tsch. Czarwony alarm! Aktywować wszystkie systemy! Scramble all ryders and prepare calculations for emergency warp out!"
    ...
    cos "Ale dość gadania! To koniec, kapitanie!"
...
label mission19:
    ...
    if check5 == False and BM.turn_count == 5:
        ...
        ava "Pozostały jeszcze dwie tury!"
...
label after_mission19:
    ...
    ava "Ludzie, którzy narzekają za dużo, nie są popularni."
    kay "... ... ..."
...
label goodbyemaray:
    ...
    cla "H-heh..."
    kay "U-ugh..."
    kay "G-gdzie jest Ava? Czy wszystko z nią w porządku?"
...
label shieldsfallenfloor:
    ...
    ava "Kapitanie. Przygotowałam pełny raport uszkodzeń."
    ...
    ava "Kapitanie. You cannot mean to take the Sunrider into battle again."
    ava "This ship is no condition to fight."
    ava "We can sit this one out. Let the Alliance handle it."
    "Shield wstał z swojego krzesła."
    ...
    kay "Za każdym razem."
    kay "Kiedy pojawił się na Cerze, wycofaliśmy się."
    kay "When it appeared on Ryuvia Prime, we retreated."
    kay "When it appeared on Far Port, we let it go."
    kay "I... I have had it."
    kay "Tym razem się nie wycofiemy!"
    kay "Ten statek... Zabił miliony naszych ludzi!!"
    kay "Sank our entire fleet!"
    kay "Zniszczył nasz świat!!"
    kay "NO MORE."
    ...
    ava "Stop it..."
    ava "Jesteś kapitanem tego statku! Nie możesz sobie pozwolić, by emocje cię kontrolowały!"
...
label satalonestaring:
    ...
    chi "...Kapitanie? Jesteś tutaj?"
    kay "... ... ..."
    chi "Czy... wszystko w porządku?"
    kay "Yeah."
    kay "Come on in."
    kay "Przepraszam za bałagan."
    ...
    kay "I fled!"
    kay "To mój błąd... It was I who failed her...!"
    chi "Shhh..."
    chi "Twój rozkaz tego dnia uratował wszystkich na pokładzie tego statku..."
    chi "To był najlepszy rozkaz jaki mogłeś wydać."
    kay "Teraz... Nic mi nie zostało..."
    kay "Nie mam domu, do którego mógłbym wrócić... Nie mam rodziny..."
    kay "Wszystkie miejsca z przeszłości... starte w proch...!"
    chi "Shh... Masz mnie kapitanie, kapitanie."
    chi "Masz twój statek. Twoją załogę."
    chi "Jesteśmy twoją rodziną."
    kay "... ... ..."
    chi "Ty... nigdy nie płakałeś, kiedy twoja siostra umarła..."
    kay "... ... ..."
    ...
    kay "... ... ..."
    chi "To jest obietnica."
    kay "Chigara...!!"
    kay "I'm sorry..."
    kay "Zabiłem ją... Ja... ją zabiłem..."
    chi "Kapitanie..."
    ...
    kay "Dzień tak jasny jak nasze wpomnienia o Cerze!"

    scene bg bridgered with dissolve

    "Załoga mostu wstała i klaskała."
...
label mission20:
    ...
    if check1 == False:
        ...
        ava "Uwaga! The Legion is dead ahead!"
        ...
        play sound "sound/objectives.ogg"
        "Cel misji: Sink the Legion"
        "Cel misji 2: The Sunrider and her ryders cannot be hit by the Legion's main cannon."
    ...
    if check2 == False and BM.turn_count == 2:
        ...
        ica "T-to jest niemożliwe! All our weapons are just bouncing off the Legion's armor!"
    ...
    if check3 == False and BM.turn_count == 4:
        ...
        play sound "sound/objectives.ogg"
        "Dodatkowy cel: Rescue the Alliance fleet to use them against the Legion."
...
label after_mission20:
    ...
    ava "We are on our approach! Dystans: 10000!"
    ...
    kay "OGNIA!!"
    "... ... ..."
    "Rozkaz Shielda nie dał efektu."
    kay "Powiedziałem, ognia!"
    ...
    ava "Uwaga! Legion napędza swoje główne działo!"
    ...
    if captain_moralist > captain_prince:
        ...
        if wishall == True:
            menu:
                ...
                "Are you crazy, commander!? To zbyt niebezpieczne!":
...
label CMDgetvanguardthe:
    ...
    if BM.cmd < 3000:
        ...
        "Insufficient command points"
        kay "Are you crazy, commander!? To zbyt niebezpieczne!"
        jump crazycommandertoo
...
label getvanguardthe:
    ...
    kay "We've begun our approach! Dystans: 6000!"
    ...
    chi "Kapitanie! The Legion is preparing to fire its primary cannon!"
    chi "The Sunrider will not fire the Vanguard in time!"
    chi "You must break off the attack!!"
    kay "... ... ..."
    kay "Nie... Ava will make it!!"
    chi "KAPITANIE!!!"
    ...
    chi "KAPITANIE!! BREAK OFF!!! BREAK OFF!!!"
    kay "Nie...!"
    kay "To działa! SHE DID IT!!"
...
label plancomefruition:
    ...
    arc "Hahahaha...!"
    kay "ARKADIUSIE!! Tu jesteś!"
    arc "Witaj, kapitanie! Na naszym festiwalu!"
    kay "All ryders! Take out Arcadius, now!"
    kay "We can end this war here and now!"
    arc "Zakończyć tę wojnę?"
    arc "Oh no captain."
    ...
    arc "WE... ARE... ARCADIUS!"
    arc "Hahahaha!! Teraz widzisz, kapitanie?"
    ...
    asa "Jestem więcej niż dziewczyną...!"
    asa "Jestem więcej niż bohaterką!"
    asa "Jestem..."
    ...
    arc "Co!?"
    asa "ARKADIUSIE!! Zapłacisz za to co zrobiłeś mojemu ojcu!"
...
label after_mission21:
    ...
    kay "Arcadiusie... Jesteś... nieludzki!!"
    arc "Haha!! Precisely!"
    ...
    fon "Wielki Arkadius popełnił tylko jeden mały błąd! It was allowing a monstrosity like you into our ranks!"
...
label aftercredits7:
    ...
    "NASTĘPNYM RAZEM W SUNRIDERZE..."
    "Arcadius zostanie zdemaskowany!"
    ...
    "One will betray the Sunrider. Ale kto?"
    ...
    menu:
        "Chcesz przygotować specjalny zapis, który zostanie zaimportowany do części 3? To nadpisze poprzedni jeśli istnieje."
        
        "Tak.":
            $ update_mp()
            "Twój postęp został zapisany prawidłowo."
        "Nie.":
            $ pass
    stop music fadeout 1.5
    scene white with dissolvelong
...
label aftercredits6:
    ...
    "Przeszłość Kapitana zostaje ujawniona!"
    "Sunrider vs. Legion!"
    "The mask of Arcadius will shatter!"
    "The shocking truth!"
    "All this and more in..."
    "SUNRIDER: MASKA ARCADIUSA"
    "...i nie zapomnij, będzie dużo kosmicznych wielorybów następnym razem również!"
    ...
    "A teraz... The results of our great waifu war!"
    "A wgraną jest..."
...
label aftercredits4:
    ...
    "I nie zapomnij... There'll be lots of space whales next time too!"
    ...
    chi "A-ah! Ja... Ja znów wygrałam!"
    chi "(Didn't expect that to happen.)"
    chi "O-oh my..."
    chi "D-Dziękuję wszystkim za głosowanie na mnie! Eh-heh..."
...
label aftercreditsep3:
    ...
    "A teraz... Wyniki naszego drugiego konkursu popularności!"
    "A zwyciężczynią jest..."
    ...
    "Kto wygra następnym razem? Nie zapomnij głosować na naszym forum!"
...
label aftercreditsep2:
    ...
    asa "Ze zliczonymi 33 głosami, zwycięzcą jest..."
    ...
    chi "O-oh? J-ja? *Never expected to win*"
...
label skiptomaskofarcadius:
    ...
    "Witamy w kampanii Maski Arcadiusa. Wysoce zalecane jest zakończyć kampanię Pierwsza Podróż przed zagraniem w Maskę Arcadiusa."
...
label continuewithchoices:
    ...
    menu:
        "Zasugerowałem zostać statkiem pirackim.":
            jump rb_pirateship
        "Pozostałem pod flagą Cery.":
            jump rb_flagcera
...
label rb_2:
    ...
    "Kiedy przybyłem na pokład Sunridera..."

    menu:
        "Byłem przyjacielski dla Avy":
            jump rb_friendlyava
...
label rb_3:
    ...
    "Kiedy Asaga weszła na pokład..."

    menu:
        "Trzymałem stronę Asagi":
            jump rb_sideasaga

        "Trzymałem stronę Avy":
            jump rb_sideava
...
label rb_15:
    ...
    menu:
        "Powiedziałem jej, że jej technologia może być niebezpieczna jeśli zostanie niewłaściwie użyta":
            jump rb_techdanger
        "Powiedziałem jej, że I told her chciałbym mieć mocniejszą technologię":
...
label rb_16:
    ...
    if store.Difficulty == 3:
        $ show_message('Proszę wybrać swój poziom trudności.',0.5,0.8,2)
        show screen gameprefs
