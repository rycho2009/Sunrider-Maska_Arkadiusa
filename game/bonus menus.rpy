init -1 python:
    ...
    doki_doki_space_whale = BonusItem("Background/renpytomback.jpg", " Symulator randkowy\n Doki Doki Space Whale:\n Dating Sim 3", "deleted_scene_1", 0.09)
            ...
            for i in range(1, columns * rows + 1):
                ...
                button:
                    ...
                    if bonusPage * columns * rows + i - 1 < len(scenes):
                        ...
                        text str(bonusPage * columns * rows + i) + ". Usunięta scena"
            ...
            for i in range(1, columns * rows + 1):
                ...
                button:
                    ...
                    if bonusPage * columns * rows + i - 1 < len(chapters):
                        ...
                        text str(bonusPage * columns * rows + i) + ". Niezapisany rozdział"
            ...
            for i in range(1, columns * rows + 1):
                ...
                button:
                    ...
                    if bonusPage * columns * rows + i - 1 < len(addon_scenes):
                        ...
                        text str(bonusPage * columns * rows + i) + ". Brak sceny"                        