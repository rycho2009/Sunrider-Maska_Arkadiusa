...
#    $ upgrade_list.append(ship.upgrades['move_cost'])  #probably should be set individually in design
    ...
    if can_use_melee:
        $ upgrade_list.append(["WRĘCZ -----------",None,None,None,None])
    ...
    $ upgrade_list.append(["OBRONNE -----------",None,None,None,None])
    ...
    $ funds_text = '${!s}'.format(BM.money) if BM.mission!='skirmish' else 'NIELIMITOWANE'
    text funds_text:
        size 50
        xpos 70
        ypos 0.76
