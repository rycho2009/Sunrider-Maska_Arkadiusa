        ...
        def destroy(self,attacker,no_animation = False):
            ...
            if not no_animation:
                try:
                    ...
                    show_message('Brakująca Animacji. "die_{}" nie istnieje'.format(self.animation_name))
...
##############SUNRIDER WEAPONS
    class SunriderLaser(Laser):
        def __init__(self):
            ...
            self.tooltip = """
            Lasery są celne nawet z dużych odległości, ale brakuje im siły ognia.
            Obrażenia są niwelowane przez tarcze przeciwników."""
    ...
    class SunriderMissile(Missile):
        def __init__(self):
            ...
            self.tooltip = """
            Odpala salwę pocisków nakierowanych w przeciwnika. Pojedynczo słabe,
            ich większa ilość zapewnia wysoką siłę ognia oraz wysoką celność nawet
            na dużym dystansie. Ograniczone zasoby. Działa obronne oraz ciężkie opancerzenie przeciwnika ogranicza ich potencjał."""
    ...
    class SunriderKinetic(Kinetic):
        def __init__(self):
            ...
            self.tooltip = """
            Działa kinetyczne mają dużą siłę uderzenia lecz są nieskuteczne przeciwko małym bądź odległym celom.
            Pancerz jest podwójnie skuteczny w ograniczaniu uszkodzeń zadawanych przez broń kinetyczną."""
    ...
    class SunriderPulse(Laser):
        def __init__(self):
            ...
            self.tooltip = """
            Wystrzeliwuje sporą ilość pulsów laserowych. Nawet jeśli przeciwnik uniknie jednego
            pozostałe wciąż mogą trafić. Zbiorczo są potężniejsze niż lasery
            lecz nie mogą przebijać pancerza. Niwelowane przez tarcze."""
    ...
    class SunriderAssault(Kinetic):
        def __init__(self):
            ...
            self.tooltip = """
            Działa obronne wystrzeliwują grad małych pocisków w stronę przeciwnika.
            Nawet jeśli wróg ominie jeden pozostałe wciąż mogą trafić. Pancerz jest podwójnie
            skuteczny przeciwko temu atakowi. Używane też do zestrzeliwania nadlatujących rakiet
            lecz traci skuteczność przeciwko długotrwałemu ostrzałowi."""
    ...
    class SunriderRocket(Missile):
        def __init__(self):
            ...
            self.tooltip = """
            Odpala wielką rakietę z dewastującą głowicą w kierunku przeciwnika.
            Bardzo ograniczone w zasobach. Może być zesprzelona przez artylerię przeciwlotniczą przeciwnika."""
...
##############ALLIANCE BATTLESHIP WEAPONS
    ...
    class AllianceBattleshipCannon(Kinetic):
        def __init__(self):
            ...
            self.tooltip = """
            Broń ostateczna w międzygwiezdnej destrukcji. Przebije nawet
            najtwardszy pancerz lecz wymaga ogromnych ilości energii. Nieskuteczne przeciw
            małym celom."""
...
###################BLACK JACK WEAPONS
    ...
    class BlackjackMelee(Melee):
        def __init__(self):
            ...
            self.tooltip = """
            Przecina wrogiego mecha dla dewastujących uszkodzeń. Może zostać użyte tylko na sąsiadujących
            mechach. Zbliżenie się do wrogiego mecha wywoła kontratak."""
...
### SUPPORT SKILLS ###
    ...
    class AccUp(Support):
        def __init__(self):
            ...
            self.tooltip = """
            Cel otrzymuje 15 punktów do celności.
            Ma zasięg 3 pól."""
    ...
    class DamageUp(Support):
        def __init__(self):
            ...
            self.tooltip = """
            Zwiększa obrażenia celu o 20 procent.
            Ma zasięg 3 pól."""
    ...
    class Restore(Support):
        def __init__(self):
            ...
            self.tooltip = """
            Usuwa wszystkie zmiany statusów nałożone przez przeciwnika.
            Ma zasięg 3 pól."""
    ...
    class Stealth(Support):
        def __init__(self):
            ...
            self.tooltip = """
            Staje się niewrażliwy na kontrataki przez 1 turę"""
    ...
    class Awaken(Support):
        def __init__(self):
            ...
            self.tooltip = """
            Czasowo przeładowywuje system Seraphim'a zapewniając
            dodatkowe 100 punktów do celności jak również
            podwaja obrażenia na trzy tury."""
    ...
    class AwakenAsaga(Support):
        def __init__(self):
            ...
            self.tooltip = """
            Co turę zwiększa zadawane uszkodzenia, uniki i celność Black Jacka 
            ale zadaje mu coraz więcej uszkodzeń co turę do wyłączenia umiejętności."""
...
#### curse skills ####
    ...
    class AccDown(Curse):
        def __init__(self):
            ...
            self.tooltip = """
            Redukuje celność celu o 25 punktów."""
    ...
    class Disable(Curse): #takes away all EN
        def __init__(self):
            ...
            self.tooltip = """
            Całkowicie wyłącza cel na jedną turę."""
    ...
    class FlakOff(Curse):
        def __init__(self):
            ...
            self.tooltip = """
            Cel nie może kontratakować ani ostrzeliwać nadlatujących rakiet przez dwie tury."""
    ...
    class ShutOff(Curse):  #shuts down shield generation
        def __init__(self):
            ...
            self.tooltip = """
            Deaktywuje tarczę celu na dwie tury."""
    ...
    class ShdJam(Curse):  #shuts down shield generation
        def __init__(self):
            ...
            self.tooltip = """
            Czasowo redukuje generowanie tarczy celu o 15 punktów. Może być użyte wielokrotnie na tym samym celu."""
...
################################################# SERAPHIM
    class SeraphimKinetic(Kinetic):
        def __init__(self):
            ...
            self.accuracy = 150
            self.tooltip = """
            Karabin Soli jest elegancką bronią z bardziej cywilizowanych czasów.
            Niezwykle potężna i celna broń lecz wymaga sporo energii."""
...
################################################### BIANCA
    ...
    class BiancaAssault(Kinetic):
        def __init__(self):
            ...
            self.lbl = Image('Battle UI/button_kinetic.png')
            self.tooltip = """
            Zapewnia niezawodną siłę ognia, lecz jest wysoce niecelny chyba, że cel
            jest blisko i jest duży. Może być również użyty do kontrataku."""
...
###################################################### ARCADIUS
    ...
    class NewWarhead(StoreItem):
        def __init__(self):
            ...
            self.cost = 300
            self.tooltip = 'Zakupienie głowic pozwala Sunriderowi na wystrzelenie potężnej rakiety w przeciwnika. Rakieta zadaje {} obrażeń, ale może być zestrzelona przez działa obronne. Sunrider może przewozić maksymalnie 2 na raz.'.format(sunrider.weapons[3].damage)
    ...
    class RocketUpgrade(StoreItem):
        def __init__(self):
            ...
            self.cost = 2000
            self.tooltip = 'Podczas gdy rozpowszechnienie się głowic nuklearnych w galaktyce sprawiło, że są ogólnodostępne,potężniejsza broń jest regulowana przez Gwiezdne Porozumenie. Za uiszczeniem odpowiednich opłat, Unia Górnicza może wyminić głowice nuklearne na kwantowe, permanentnie zwiększając uszkodzenia od torped Sunridera do 1200.'
    ...
    class RepairUpgrade(StoreItem):
        def __init__(self):
            ...
            self.display_name = "PRZENOŚNY PRZYSPIESZACZ NAPRAW"
            self.cost = 1000
            self.tooltip = 'Podczas gdy rozległe naprawy wymagają czasu w suchym doku, naprawy na froncie są niezbędne w utrzymaniu zdolności bojowej. Te nowe przenośne drony naprawcze pozwolą Liberty naprawić 200 więcej HP. Te ulepszenie zmniejsza również o 10 koszt Energii'
    ...
    class NewRepairDrone(StoreItem):
        def __init__(self):
            ...
            self.cost = 400
            self.tooltip = 'Te autonomiczne roboty mogą w krótkim czasie odnowić zniszczone sekcje pancerza jak również skomplikowane systemy elektroniczne. Konieczność podczas operacji na wrogim terenie.  Przywraca przy użyciu 50% HP Sunridera. Sunrider może przewozić maksymalnie 8 na raz.'
    ...
    class ContractAllianceCruiser(StoreItem):
        def __init__(self):
            ...
            self.display_name = "SOJUSZNICZY KRĄŻOWNIK"
            self.cost = 2000
            ...
            self.max_amt = 2
            self.tooltip = 'Wraz z wypowiedzeniem wojny przez Gwiezdny Kongres, niezliczone krążowniki zostały ściągnięte na front. Za hojną opłatą, Unia Górnicza może wykorzystać swój wpływ w Gwiezdnym Kongresie by przydzielić w pełni operacyjny krążownik jako eskorta Sunridera. Mimo iż są powolne, krążowniki są wytrzymałe i mają dobrą siłę ognia. Możesz mieć {} w swojej flocie w dowolnym czasie'.format(self.max_amt)
    ...
    class ContractUnionFrigate(StoreItem):
        def __init__(self):
            ...
            self.max_amt = 4
            self.tooltip = 'Unia Górnicza ma na stanie prywatną armię do obrony swoich transportów przed piratami. Za uiszczeniem odpowiednich opłat, też możesz mieć fregatę Unii jako swoją eskortę. Małe i lekko opancerzone, te fregaty są tanie i szybkie. Możesz mieć {} w swojej flocie w dowolnym czasie'.format(self.max_amt)
    ...
    class SellWishallArtifact(StoreItem):
        def __init__(self):
            StoreItem.__init__(self)
            self.id = 'wishall'
            self.display_name = "SPRZEDAJ STUDNIĘ ŻYCZEŃ"
            self.cost = -10000
            self.tooltip = 'Studnia Życzeń to starożytny Ryuwiański artefakt który pozwala użytkownikowi podjąć jedną ważną decyzję za darmo podczas całej historii. Ewentualnie, możesz ją sprzedać za natychmiastowy zastrzyk gotówki w formie 10 000 kredytów.'
    ...
    class SunriderShieldUpgrade(StoreItem):
        def __init__(self):
            ...
            self.cost = 1500
            self.tooltip = "W związku z nieprzewidzianym odlotem z Cery Sunrider nie został wyposażony w generator tarczy. Podczas gdy jej wojskowy generator przepadł wraz z upadkiem Cery, Unia może wyposażyć Sunridera w podstawowy generator. Po zakupie Tarcze mogą zostać ulepszone na ekranie Badania i Rozwój."
    ...
    class BlackJackThrusters(StoreItem):
        def __init__(self):
            ...
            self.cost = 750
            self.tooltip = "Black Jack został zaprojektowany tak by był kompatybilny z wojskowymi dopalaczami, lecz te nie są łatwe do zdobycia. Dzięki twoim kontaktom w Unii Górniczej, to nie jest już powód by go spowalniać."
    ...
    class GravityGunBooster(StoreItem):
        def __init__(self):
            ...
            self.cost = 750
            self.tooltip = "Chigara może zwiększyć skuteczność działa grawitacyjnego Bianci poprzez dodanie jednego z tych urządzeń. Koszt użycia spada do 40 energii (z 60)."
    ...
    class SunriderVanguardUpgrade(StoreItem):
        def __init__(self):
            ...
            self.cost = 1100
            self.tooltip = "Zwiększa obrażenia działa Vanguard z 800 do 1000 oraz zwiększa zasięg o 1 pole"
