...
#####################################SPACE BACKGROUNDS
    ...
    image intro1 = Text("Ludzkość rozproszyła się na cztery krańce galaktyki.{p}Ujarzmiając całe życie w kosmosie, staliśmy się dominującym gatunkiem.", size=30, font="Font/GOTHIC.TTF", text_align=0.5)
    image intro2 = Text("Jednak daleko nam do bezpieczeństwa.", size=30, font="Font/GOTHIC.TTF", text_align=0.5)
    image intro3 = Text("Wojna wrzy się z północnego kwadrantu galaktyki.{p}PACT, the People's Alliance, has toppled the once mighty New Empire.", size=30, font="Font/GOTHIC.TTF", text_align=0.5)
    ...
    image intro5 = Text("Distant from the brewing clouds of war, {p}the neutral world of Cera seemed safe from the approaching PACT war machine.{p}Na tym cichym świecie nasza podróż się zaczyna...", size=30, font="Font/GOTHIC.TTF", text_align=0.5)
    image comingsoon = Text("SUNRIDER JEST W TRAKCIE BUDOWY", size=30, font="Font/GOTHIC.TTF", text_align=0.5)
    ...
    image credits7 = Text("Tekstury 3D{p}         CGTextures", size=30, font="Font/GOTHIC.TTF", text_align=0.5)
    ...
    image credits17 = Text("Kapitan Kayto Shields:  Jonathan Cooke", size=30, font="Font/GOTHIC.TTF", text_align=0.5)    
    ...
    image credits27 = Text("Dziękujemy również podążającym na Kickstarterze sponsorom...", size=30, font="Font/GOTHIC.TTF", text_align=0.5)
